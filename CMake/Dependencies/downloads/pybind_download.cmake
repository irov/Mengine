set(EXTERNAL_PROJECT_NAME pybind)

set(EXTERNAL_LIBRARY_FILE_NAME pybind)
...
ExternalProject_Add(${EXTERNAL_PROJECT_NAME}_download PREFIX ${EXTERNAL_PROJECT_NAME}
        ...
        CMAKE_ARGS
            ...
            -DLIBTYPE=STATIC
            -DPYBIND_PROJECT_NAME="pybind"
            -DPYBIND_EXTERNAL_BUILD=ON
            -DPYBIND_PYTHON_INCLUDE_PATH=${THIRDPARTY_DIR}/python/include
            -DPYBIND_PYTHON_CONFIG_INCLUDE_PATH=${THIRDPARTY_DIR}/python/include/PC
            -DPYBIND_STDEX_INCLUDE_PATH=${THIRDPARTY_DIR}/stdex/include
            -DPYBIND_PYTHON_VERSION=278
)
