#ftp http://downloads.sourceforge.net/project/boost/boost/1.48.0/boost_1_48_0.zip
...
###################	pybind
getdepend http://netcologne.dl.sourceforge.net/project/pybind/pybind-1.0.zip pybind-1.0.zip pybind-1.0 pybind
