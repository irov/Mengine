...
namespace Menge
{
	...
	public:
		...
		unsigned char* getAlphaBuffer( ResourceImage * _resourceImage, std::size_t _frame, size_t & _width, size_t & _height );	// increases ref counter
	...
	protected:
		bool makeAlphaBuffer( ResourceImage * _resourceImage, std::size_t _frame );
