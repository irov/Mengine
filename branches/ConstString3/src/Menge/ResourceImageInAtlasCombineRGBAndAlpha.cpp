...
//{
//	//////////////////////////////////////////////////////////////////////////
//	RESOURCE_IMPLEMENT( ResourceImageInAtlasCombineRGBAndAlpha );
//	//////////////////////////////////////////////////////////////////////////
//	ResourceImageInAtlasCombineRGBAndAlpha::ResourceImageInAtlasCombineRGBAndAlpha()
//	{
//	}
//	//////////////////////////////////////////////////////////////////////////
//	RenderTextureInterface* ResourceImageInAtlasCombineRGBAndAlpha::getTexture() const
//	{
//		return m_resourceAtlas->getTexture();
//		//return m_imageFrame.texture;
//	}
//	//////////////////////////////////////////////////////////////////////////
//	void ResourceImageInAtlasCombineRGBAndAlpha::loader( const Metabuf::Metadata * _parser )
//	{
...
//	}
//	//////////////////////////////////////////////////////////////////////////
//	bool ResourceImageInAtlasCombineRGBAndAlpha::_compile()
//	{	
//		if( m_resourceAtlasName.empty() == true )
//		{
//			MENGE_LOG_ERROR( "ResourceImageInAtlasCombineRGBAndAlpha: '%s' ImageAtlas resource empty"
//				, m_name.c_str() 
//				);
//
//			return false;
...
//		{
//			MENGE_LOG_ERROR( "ResourceImageInAtlasCombineRGBAndAlpha: '%s' ImageAtlas resource not found '%s'"
//				, m_name.c_str()
...
//		if( result == false )
//		{
//			MENGE_LOG_ERROR("Texture::ResourceImageInAtlasCombineRGBAndAlpha: Invalid fill atlas texture"
//				);
//
//			return false;
//		}
...
//	}
//	/////////////////////////////////////////////////////////////////////////
//	void ResourceImageInAtlasCombineRGBAndAlpha::_release()
//	{
//		ResourceManager::get()
