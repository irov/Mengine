...
//	{
//		/*m_image = Holder<RenderEngine>::get()->loadImage( m_path, 0 );
//		
//		if( m_image == 0 )
//		{
...
//			String path = m_path + tilestr + ".png";
//			
//			const ConstString & category = this->getCategory();
//
//			ConstString ccodec = ConstManager::get()
//				->genString( "pngImage" );
//
//			Texture* image = RenderEngine::get()
//				->loadTexture( category, path, Consts::get()->c_pngImage );
//
