...
namespace Menge
{
	...
	void Window::_render( RenderCameraInterface * _camera )
	{
		...
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_LeftTop], &m_textures[ResourceWindow_LeftTop], 1, &vertices[1*4], 4, LPT_QUAD );
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_RightTop], &m_textures[ResourceWindow_RightTop], 1, &vertices[3*4], 4, LPT_QUAD );
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_RightBottom], &m_textures[ResourceWindow_RightBottom], 1, &vertices[5*4], 4, LPT_QUAD );
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_LeftBottom], &m_textures[ResourceWindow_LeftBottom], 1, &vertices[7*4], 4, LPT_QUAD );
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_Top], &m_textures[ResourceWindow_Top], 1, &vertices[2*4], 4, LPT_QUAD );
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_Bottom], &m_textures[ResourceWindow_Bottom], 1, &vertices[6*4], 4, LPT_QUAD );
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_Right], &m_textures[ResourceWindow_Right], 1, &vertices[4*4], 4, LPT_QUAD );
		renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_Left], &m_textures[ResourceWindow_Left], 1, &vertices[8*4], 4, LPT_QUAD );
		
		if( this->hasBackground() == true )
		{
			renderEngine->addRenderObject2D( _camera, m_material[ResourceWindow_Background], &m_textures[ResourceWindow_Background], 1, &vertices[0*4], 4, LPT_QUAD );
		}
	}
	//////////////////////////////////////////////////////////////////////////
