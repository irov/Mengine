...
namespace mt
{
	...
	MATH_FUNCTION_INLINE void add_v4_v3(vec4f& _out, const vec4f& _a, const vec4f& _b);
	MATH_FUNCTION_INLINE void add_v4_v4(vec4f& _out, const vec4f& _a, const vec3f& _b);
