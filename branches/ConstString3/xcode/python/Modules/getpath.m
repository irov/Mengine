...
calculate_path(void)
{
    ...
    char *documentsDirectory = [[NSString stringWithFormat:@"%@/", [[NSBundle mainBundle] resourcePath]] cString];
    
    static char delimiter[2] = {DELIM, '\0'};
    static char separator[2] = {SEP, '\0'};
    char *pythonpath =  [[NSString stringWithFormat:@"%@/:%@/pylib/", [[NSBundle mainBundle] resourcePath], [[NSBundle mainBundle] resourcePath]] cString];
    char *rtpypath = documentsDirectory;
    char *home = documentsDirectory;
    char *path = documentsDirectory;
