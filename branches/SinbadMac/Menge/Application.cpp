...
namespace Menge
{
	...
	bool Application::initialize( const String& _applicationFile, const String & _args, bool _loadPersonality )
	{
        ...
        MENGE_LOG_ERROR("Initializing Thread System...");
...
#	endif
		...
		if( m_renderEngine->initialize( 8000 ) == false )
		{
        ...
        float maxWindowHeight = contentResolution.getHeight();
...
#	endif
	...
	{
        static int count = _fullscreen ? 1 : 0;
        static bool wantFullscreen = m_fullscreen;
		...
		m_game->onFullscreen( wantFullscreen );
