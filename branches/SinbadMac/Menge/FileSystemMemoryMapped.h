...
namespace Menge
{
	...
	public:
		...
		bool initialize( const String& _path, bool _create );
		bool existFile( const String& _filename );
		FileInput* createInputFile();
		bool openInputFile( const String& _filename, FileInput* _file );
		void closeInputFile( FileInput* _file );
