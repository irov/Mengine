...
namespace Menge
{
	...
	{
        /*Viewport v = _viewport;
        v.begin.y = 768 - _viewport.end.y;
        v.end.y = 768 - _viewport.begin.y;
        
        //NSLog( @"x %f %f y %f %f", v.begin.x, v.end.x, v.begin.y, v.end.y );
        
		const mt::mat3f& wm = getWorldMatrix();
		mt::vec2f min, max;
		mt::mul_v2_m3( min, v.begin, wm );
		mt::mul_v2_m3( max, v.end, wm );
        ...
        //NSLog( @"x %f %f y %f %f", min.x, max.x, min.y, max.y );
		m_renderViewport.begin = min;
		m_renderViewport.end = max;
        
        /*m_renderViewport.begin = mt::vec2f( 0.f, 0.f );
        m_renderViewport.end = mt::vec2f( 1024.f, 768.f );*/
	}
	//////////////////////////////////////////////////////////////////////////
