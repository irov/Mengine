...
namespace	Menge
{
	...
	void Scene::render( Camera2D * _camera )
	{
       ...
       /*sprintf( buffer, "Scene::render\n" );
        Menge::Holder< Menge::Application >::hostage()->logMessage( buffer, Menge::LM_LOG );*/
        
        if( m_mainLayer == 0 )
            Menge::Holder< Menge::Application >::hostage()->logMessage( "PIZDEC!!!!11111", Menge::LM_LOG );
        
        /*sprintf( buffer, "m_mainLayer = %i\n", m_mainLayer );
        Menge::Holder< Menge::Application >::hostage()->logMessage( buffer, Menge::LM_LOG );*/
