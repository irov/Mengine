...
namespace Menge
{
	...
	bool OGLRenderSystem::initialize( LogSystemInterface* _logSystem, RenderSystemListener* _listener )
	{
        ...
        /*if( Menge::Holder< Menge::Application >::hostage()->getFullscreenMode() )
        {
            NSRect mainDisplayRect = [ [ NSScreen mainScreen ] frame ];
            
            m_winContextWidth = mainDisplayRect.size.width;
            m_winContextWidth = mainDisplayRect.size.height;
        }
        else
        {
            m_winContextWidth = 1024;
            m_winContextWidth = 768;
        }*/
												...
												bool _waitForVSync, int _FSAAType, int _FSAAQuality )
	{
        ...
        if( needFullscreen )
        {
            ...
            m_winContextWidth = r.size.width;
            m_winContextHeight = r.size.height;
        }
        else
        {
            m_winContextWidth = 1024;//_width;
            m_winContextHeight = 768;//_height;
        }
	...
	bool OGLRenderSystem::unlockVertexBuffer( VBHandle _vbHandle )
	{
		...
		if( true/*!GLEE_EXT_vertex_array_bgra*/ )
		{
			// swap r/b
	...
	void OGLRenderSystem::changeWindowMode( const Resolution & _resolution, bool _fullscreen )
	{
        ...
        MENGE_LOG( "OGLRenderSystem::changeWindowMode: m_winContextWidth = %i m_winContextHeight = %i", m_winContextWidth, m_winContextHeight );
	}
	//////////////////////////////////////////////////////////////////////////
