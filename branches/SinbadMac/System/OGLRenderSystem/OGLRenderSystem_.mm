...
namespace Menge
{
	...
	{
        m_winContextWidth = 1024;
		m_winContextHeight = 768;
#if 0
	...
	void OGLRenderSystem::setProjectionMatrix( const float * _projection )
	{
        ...
        /*NSLog( @"projection:" );
        NSLog( @"%f %f %f %f", mat[ 0 ], mat[ 1 ], mat[ 2 ], mat[ 3 ] );
        NSLog( @"%f %f %f %f", mat[ 4 ], mat[ 5 ], mat[ 6 ], mat[ 7 ] );
        NSLog( @"%f %f %f %f", mat[ 8 ], mat[ 9 ], mat[ 10 ], mat[ 11 ] );
        NSLog( @"%f %f %f %f", mat[ 12 ], mat[ 13 ], mat[ 14 ], mat[ 15 ] );*/

		glLoadMatrixf( /*mat*/_projection );

		glMatrixMode( GL_MODELVIEW );
	}
	//////////////////////////////////////////////////////////////////////////
	void OGLRenderSystem::setModelViewMatrix( const float * _view )
	{
		GLfloat mat[16];
		s_toGLMatrix( mat, _view );
        /*NSLog( @"model:" );
        NSLog( @"%f %f %f %f", mat[ 0 ], mat[ 1 ], mat[ 2 ], mat[ 3 ] );
        NSLog( @"%f %f %f %f", mat[ 4 ], mat[ 5 ], mat[ 6 ], mat[ 7 ] );
        NSLog( @"%f %f %f %f", mat[ 8 ], mat[ 9 ], mat[ 10 ], mat[ 11 ] );
        NSLog( @"%f %f %f %f", mat[ 12 ], mat[ 13 ], mat[ 14 ], mat[ 15 ] );*/
		glLoadMatrixf( /*mat*/_view );
	}
	//////////////////////////////////////////////////////////////////////////
	...
	{        
        ...
        //if( _viewport.begin.x == 0.f && _viewport.begin.y == 0.f && _viewport.end.x == m_winContextWidth && _viewport.end.y == m_winContextHeight )
            glViewport( _viewport.begin.x, _viewport.begin.y, w, h );
       /* else
        {
            float begin = 768 - _viewport.end.y;
            float end = 768 - _viewport.begin.y;
            glViewport( _viewport.begin.x, begin, w, end - begin );
        }*/
		
        //NSLog( @"%f %f %f %f", _viewport.begin.x, _viewport.begin.y, w, h );
