...
namespace Menge
{
    char g_resDirectory[ 1024 ];
    
	//////////////////////////////////////////////////////////////////////////
	PosixFileSystem::PosixFileSystem()
	{
        [ [ [ NSBundle mainBundle] resourcePath ] getCString : g_resDirectory
                                                   maxLength : sizeof( g_resDirectory ) - 1
                                                    encoding : NSASCIIStringEncoding ];
        
        strcat( g_resDirectory, "/" );
	}
	//////////////////////////////////////////////////////////////////////////
	PosixFileSystem::~PosixFileSystem()
	{
	...
	bool PosixFileSystem::existFile( const String& _filename )
	{
		...
		return access( _filename.c_str(), F_OK ) == 0 || access( ( String( g_resDirectory ) + _filename ).c_str(), F_OK ) == 0;
	}
	//////////////////////////////////////////////////////////////////////////
