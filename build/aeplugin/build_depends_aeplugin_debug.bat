...
@pushd ..
@call cmake_configure "%CD%\..\dependencies\cmake\bin\cmake.exe" "%CD%\..\CMake\Depends_AEPlugin" "..\dependencies\build_aeplugin" "Visual Studio 12 2013 Win64" Debug
@popd

@pushd ..\..\dependencies\build_aeplugin\Debug 
