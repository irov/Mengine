...
if defined BUILD_PUBLISH (
    set "MENGINE_BUILD_MENGINE_BUILD_PUBLISH=-DMENGINE_BUILD_MENGINE_BUILD_PUBLISH:BOOLEAN=%BUILD_PUBLISH%"
) else (
    set "MENGINE_BUILD_MENGINE_BUILD_PUBLISH=-DMENGINE_BUILD_MENGINE_BUILD_PUBLISH:BOOLEAN=OFF"
)
