...
if defined RESOURCE_GIT_SHA1 (
    set "MENGINE_RESOURCE_GIT_SHA1=%RESOURCE_GIT_SHA1%"
) else (
    set "MENGINE_RESOURCE_GIT_SHA1=0000000000000000000000000000000000000000"
)
