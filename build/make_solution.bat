...
if defined EXTERNAL_PDB_PATH (
    set "MENGINE_EXTERNAL_PDB=-DMENGINE_EXTERNAL_PDB:BOOLEAN=ON"
    set "MENGINE_EXTERNAL_PDB_PATH=-DMENGINE_EXTERNAL_PDB_PATH:STRING=%MENGINE_EXTERNAL_PDB_PATH%"
) else (
    set "MENGINE_EXTERNAL_PDB=-DMENGINE_EXTERNAL_PDB:BOOLEAN=OFF"
...
CMake -G "%GENERATOR%" %CMAKE_PLATFORM_TOOLSET% %CMAKE_ARCHITECTURE% -S "%SOURCE_DIRECTORY%" "-DCMAKE_CONFIGURATION_TYPES:STRING='%CONFIGURATION%'" "-DCMAKE_BUILD_TYPE:STRING=%CONFIGURATION%" %MENGINE_EXTERNAL_PDB% %MENGINE_EXTERNAL_PDB_PATH% %MENGINE_BUILD_VERSION%
