...
@pushd ..
@call cmake_configure "%CD%\..\dependencies\cmake\bin\cmake.exe" "%CD%\..\CMake\Depends_WIN32" "..\dependencies\build_msvc12" "Visual Studio 12 2013" "" "-DCMAKE_CONFIGURATION_TYPES:STRING='Release'" "-DCMAKE_BUILD_TYPE:STRING='Release'"
@popd
