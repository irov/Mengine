...
@pushd ..
@call cmake_configure CMake "%CD%\..\CMake\Depends_WIN64" "..\dependencies\build_msvc12_x64_debug" "Visual Studio 12 2013 Win64" "" "-DCMAKE_CONFIGURATION_TYPES:STRING='Debug'" "-DCMAKE_BUILD_TYPE:STRING='Debug'"
@popd
