...
SOLUTION_NAME=dependencies_xcode_ios
SOLUTION_DIR=$PWD/../../solutions/$SOLUTION_NAME/$CONFIGURATION
SOURCE_DIRECTORY=$PWD/../../cmake/Depends_Xcode_iOS

mkdir -p $SOLUTION_DIR

pushd $SOLUTION_DIR
$CMAKE -G"Xcode" -S "$SOURCE_DIRECTORY" -DCMAKE_BUILD_TYPE:STRING=$CONFIGURATION -DCMAKE_DISABLE_PRECOMPILE_HEADERS=ON
