MACRO(ADD_MENGINE_COCOAPOD_GOOGLE_UTILITIES)
    ADD_MENGINE_COCOAPOD("GoogleUtilities" "NO-GIT" "8.1.2")
ENDMACRO()
...
MACRO(MENGINE_GENERATE_COCOAPODS)
    ...
    if(${LENGTH_APPLICATION_APPLE_COCOAPODS} EQUAL -1 AND ${LENGTH_APPLICATION_APPLE_GLOBAL_COCOAPODS} EQUAL -1 AND ${LENGTH_APPLICATION_APPLE_SCRIPT_PHASES} EQUAL -1)
        FILE(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/${MENGINE_PROJECT_NAME}.xcworkspace)
        FILE(WRITE ${CMAKE_BINARY_DIR}/${MENGINE_PROJECT_NAME}.xcworkspace/contents.xcworkspacedata "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<Workspace\n   version = \"1.0\">\n   <FileRef\n      location = \"group:${MENGINE_PROJECT_NAME}.xcodeproj\">\n   </FileRef>\n</Workspace>\n")
        FILE(REMOVE ${CMAKE_BINARY_DIR}/Podfile)
        FILE(REMOVE ${CMAKE_BINARY_DIR}/Podfile.lock)
        FILE(REMOVE_RECURSE ${CMAKE_BINARY_DIR}/Pods)
    else()
        SET(PODFILE_BUFFER "")
