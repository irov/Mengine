...
MACRO(SET_MENGINE_ENVIRONMENT MENGINE_TARGET MENGINE_RENDER MENGINE_PLATFORM MENGINE_TOOLCHAIN)
    ...
    IF(${CMAKE_SYSTEM_NAME} STREQUAL "WindowsStore")
        SET(MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX "uwp_")
    ELSEIF(IOS)
        SET(MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX "ios_")
    ELSEIF(APPLE)
        SET(MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX "mac_")
    ELSEIF(ANDROID)
        SET(MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX "android_")
    ELSE()
        SET(MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX)
    ENDIF()

    MESSAGE("MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX: ${MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX}")
    
    IF(MENGINE_RENDER_OPENGL)
        SET(MENGINE_THIRDPARTY_RENDER_PREFIX "ogl_")
    ELSEIF(MENGINE_RENDER_DIRECTX9)
        SET(MENGINE_THIRDPARTY_RENDER_PREFIX "dx9_")
    ELSEIF(MENGINE_RENDER_DIRECTX11)
        SET(MENGINE_THIRDPARTY_RENDER_PREFIX "dx11_")
    ELSE()
        SET(MENGINE_THIRDPARTY_RENDER_PREFIX)
    ENDIF()
    ...
    IF(CMAKE_GENERATOR_PLATFORM)
        SET(THIRDPARTY_LIB_OUT "${MENGINE_REPOSITORY}/lib/dependencies/${CMAKE_GENERATOR} ${CMAKE_GENERATOR_PLATFORM}/${MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX}${MENGINE_THIRDPARTY_RENDER_PREFIX}${MENGINE_THIRDPARTY_ARCHITECTURE_SUFFIX}")
        SET(THIRDPARTY_CONFIG_OUT "${MENGINE_REPOSITORY}/dependencies/configuration/${CMAKE_GENERATOR} ${CMAKE_GENERATOR_PLATFORM}/${MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX}${MENGINE_THIRDPARTY_RENDER_PREFIX}${MENGINE_THIRDPARTY_ARCHITECTURE_SUFFIX}")
    ELSE()
        SET(THIRDPARTY_LIB_OUT "${MENGINE_REPOSITORY}/lib/dependencies/${CMAKE_GENERATOR}/${MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX}${MENGINE_THIRDPARTY_RENDER_PREFIX}${MENGINE_THIRDPARTY_ARCHITECTURE_SUFFIX}")
        SET(THIRDPARTY_CONFIG_OUT "${MENGINE_REPOSITORY}/dependencies/configuration/${CMAKE_GENERATOR}/${MENGINE_THIRDPARTY_ARCHITECTURE_PREFIX}${MENGINE_THIRDPARTY_RENDER_PREFIX}${MENGINE_THIRDPARTY_ARCHITECTURE_SUFFIX}")
    ENDIF()
