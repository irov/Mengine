...
MACRO(SET_MENGINE_ENVIRONMENT MENGINE_TARGET MENGINE_RENDER MENGINE_PLATFORM MENGINE_TOOLCHAIN)
    ...
    IF(CMAKE_GENERATOR_PLATFORM)
        STRING(STRIP "${CMAKE_GENERATOR} ${CMAKE_SYSTEM_NAME}" MENGINE_THIRDPARTY_PLATFORM)
    ELSE()
    ...
    SET(MENGINE_DEPENDENCIES_ARCHIVE_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/archive/${MENGINE_THIRDPARTY_PLATFORM}/${MENGINE_THIRDPARTY_TARGET})
    SET(MENGINE_DEPENDENCIES_LIBRARY_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/library/${MENGINE_THIRDPARTY_PLATFORM}/${MENGINE_THIRDPARTY_TARGET})
    SET(MENGINE_DEPENDENCIES_RUNTIME_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/runtime/${MENGINE_THIRDPARTY_PLATFORM}/${MENGINE_THIRDPARTY_TARGET})
    ...
    if(ANDROID)
        ...
        SET(MENGINE_DEPENDENCIES_TEMP_DIR ${CMAKE_BINARY_DIR}/dependencies/${ANDROID_ABI})
    elseif(MINGW)
        # output paths
        ...
        SET(MENGINE_DEPENDENCIES_TEMP_DIR ${CMAKE_BINARY_DIR}/dependencies)
    elseif(APPLE)
        # output paths
    ...
    elseif(UNIX)
        ...
        if(CMAKE_GENERATOR_PLATFORM)
            ...
            SET(MENGINE_DEPENDENCIES_TEMP_DIR ${CMAKE_BINARY_DIR}/dependencies/${CMAKE_GENERATOR_PLATFORM})
        else()
            SET(MENGINE_DEPENDENCIES_ARCHIVE_OUTPUT_DIRECTORY ${MENGINE_DEPENDENCIES_ARCHIVE_OUTPUT_BASE})
            SET(MENGINE_DEPENDENCIES_LIBRARY_OUTPUT_DIRECTORY ${MENGINE_DEPENDENCIES_LIBRARY_OUTPUT_BASE})
            SET(MENGINE_DEPENDENCIES_RUNTIME_OUTPUT_DIRECTORY ${MENGINE_DEPENDENCIES_RUNTIME_OUTPUT_BASE})
    ...
    SET(THIRDPARTY_CONFIG_DIR ${MENGINE_REPOSITORY}/outputs/depends/config/${MENGINE_THIRDPARTY_PLATFORM}/${MENGINE_THIRDPARTY_TARGET}/${MENGINE_OUTPUT_SUFFIX})
...
MACRO(SET_MENGINE_SOLUTIONS_OUTPUT_DIRECTORY)
    ...
    if(ANDROID)
        ...
        SET(MENGINE_SOLUTIONS_CONFIG_DIR ${MENGINE_REPOSITORY}/outputs/solutions/config/${PROJECT_NAME}/${MENGINE_CMAKE_GENERATOR}/${MENGINE_OUTPUT_SUFFIX})
    ...
    elseif(UNIX)
        ...
        # output paths
        if(CMAKE_GENERATOR_PLATFORM)
            SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_ARCHIVE_OUTPUT_BASE}/${MENGINE_DEFINITIONS_SHA1}/${CMAKE_GENERATOR_PLATFORM})
            SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_LIBRARY_OUTPUT_BASE}/${MENGINE_DEFINITIONS_SHA1}/${CMAKE_GENERATOR_PLATFORM})
            SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_RUNTIME_OUTPUT_BASE}/${MENGINE_DEFINITIONS_SHA1}/${CMAKE_GENERATOR_PLATFORM})
            
            SET(MENGINE_SOLUTIONS_CONFIG_DIR ${MENGINE_REPOSITORY}/outputs/solutions/config/${PROJECT_NAME}/${MENGINE_CMAKE_GENERATOR}/${MENGINE_DEFINITIONS_SHA1}/${MENGINE_OUTPUT_SUFFIX})
            
            SET(CMAKE_TEMP_DIR ${CMAKE_BINARY_DIR}/solutions/${CMAKE_GENERATOR_PLATFORM})
        else()
            SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_ARCHIVE_OUTPUT_BASE}/${MENGINE_DEFINITIONS_SHA1})
            SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_LIBRARY_OUTPUT_BASE}/${MENGINE_DEFINITIONS_SHA1})
            SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_RUNTIME_OUTPUT_BASE}/${MENGINE_DEFINITIONS_SHA1})
...
MACRO(ADD_MENGINE_APPLE_LIBRARY)
    ADD_MENGINE_LIBRARY(${ARGN})
...
MACRO(ADD_MENGINE_APPLE_PLUGIN PLUGIN_NAME)
    ADD_MENGINE_PLUGIN(${PLUGIN_NAME} ${ARGN})
