...
MACRO(SET_MENGINE_ENVIRONMENT MENGINE_TARGET MENGINE_RENDER MENGINE_PLATFORM MENGINE_TOOLCHAIN)
    ...
    STRING(REPLACE " " "_" MENGINE_THIRDPARTY_PLATFORM ${CMAKE_GENERATOR})
    
    SET(MENGINE_DEPENDENCIES_ARCHIVE_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/archive/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_THIRDPARTY_PLATFORM})
    SET(MENGINE_DEPENDENCIES_LIBRARY_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/library/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_THIRDPARTY_PLATFORM})
    SET(MENGINE_DEPENDENCIES_RUNTIME_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/runtime/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_THIRDPARTY_PLATFORM})
    
    SET(MENGINE_DEPENDENCIES_TEMP_DIR_BASE ${CMAKE_BINARY_DIR}/dependencies/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_THIRDPARTY_PLATFORM})
...
MACRO(SET_MENGINE_SOLUTIONS_OUTPUT_DIRECTORY)
    ...
    SET(MENGINE_SOLUTIONS_ARCHIVE_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/solutions/archive/${PROJECT_NAME})
    SET(MENGINE_SOLUTIONS_LIBRARY_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/solutions/library/${PROJECT_NAME})
    SET(MENGINE_SOLUTIONS_RUNTIME_OUTPUT_BASE ${MENGINE_INSTALL_PATH}/${PROJECT_NAME})
    SET(MENGINE_SOLUTIONS_CONFIG_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/solutions/config/${PROJECT_NAME})
