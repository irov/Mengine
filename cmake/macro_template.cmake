...
MACRO(SET_MENGINE_ENVIRONMENT MENGINE_TARGET MENGINE_RENDER MENGINE_PLATFORM MENGINE_TOOLCHAIN)
    ...
    SET(MENGINE_PLATFORM_SDL2 OFF CACHE BOOL "MENGINE_PLATFORM_SDL2" FORCE)
    ...
    SET(MENGINE_DEPENDENCIES_ARCHIVE_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/archive/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_CMAKE_GENERATOR})
    SET(MENGINE_DEPENDENCIES_LIBRARY_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/library/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_CMAKE_GENERATOR})
    SET(MENGINE_DEPENDENCIES_RUNTIME_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/depends/runtime/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_CMAKE_GENERATOR})
    ...
    SET(THIRDPARTY_CONFIG_DIR ${MENGINE_REPOSITORY}/outputs/depends/config/${MENGINE_DEPENDENCIES_PROJECT}/${MENGINE_OUTPUT_SUFFIX})
    ...
    MESSAGE("*********************************************")
    MESSAGE("MENGINE_PLATFORM_SDL2: ${MENGINE_PLATFORM_SDL2}")
	...
	MESSAGE("MENGINE_EXTERNAL_BOOTSTRAPPER_NAME: ${MENGINE_EXTERNAL_BOOTSTRAPPER_NAME}")
...
MACRO(SET_MENGINE_SOLUTIONS_OUTPUT_DIRECTORY)
    ...
    SET(MENGINE_SOLUTIONS_CONFIG_OUTPUT_BASE ${MENGINE_REPOSITORY}/outputs/solutions/config/${PROJECT_NAME}/${MENGINE_CMAKE_GENERATOR})

    if(ANDROID)
        MESSAGE("Setup ANDROID solution output directory")
        
        # output paths
        SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_ARCHIVE_OUTPUT_BASE}/${ANDROID_ABI}/${CMAKE_BUILD_TYPE})
        SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_LIBRARY_OUTPUT_BASE}/${ANDROID_ABI}/${CMAKE_BUILD_TYPE})
        SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${MENGINE_SOLUTIONS_RUNTIME_OUTPUT_BASE}/${ANDROID_ABI}/${CMAKE_BUILD_TYPE})
        
        SET(MENGINE_SOLUTIONS_CONFIG_DIR ${CMAKE_BINARY_DIR}/mengine_config)
        
        SET(CMAKE_TEMP_DIR ${CMAKE_BINARY_DIR}/mengine_temp)
    elseif(MINGW)
        ...
        SET(MENGINE_SOLUTIONS_CONFIG_DIR ${MENGINE_SOLUTIONS_CONFIG_OUTPUT_BASE}/${MENGINE_OUTPUT_SUFFIX})
    ...
    elseif(UNIX)
        ...
        if(CMAKE_GENERATOR_PLATFORM)
            ...
            SET(MENGINE_SOLUTIONS_CONFIG_DIR ${MENGINE_SOLUTIONS_CONFIG_OUTPUT_BASE}/${CMAKE_GENERATOR_PLATFORM}/${MENGINE_OUTPUT_SUFFIX})
...
MACRO(MENGINE_EXTERNAL_BOOTSTRAPPER)
    MENGINE_PROJECT(${MENGINE_EXTERNAL_BOOTSTRAPPER_NAME})
ENDMACRO()
...
MACRO(ADD_MENGINE_FRAMEWORK)
    IF(MENGINE_EXTERNAL_BOOTSTRAPPER_NAME)
        MENGINE_ADD_CONFIGURATION(MENGINE_EXTERNAL_BOOTSTRAPPER ${MENGINE_EXTERNAL_BOOTSTRAPPER_NAME})
    ENDIF()
ENDMACRO()
...
MACRO(ADD_MENGINE_PLUGIN_MODULE)
    ...
    ADD_DEFINITIONS(-DMENGINE_LIBRARY_NAME="${PROJECT_NAME}")
    ADD_DEFINITIONS(-DMENGINE_LIBRARY_MODULE)
