...
MACRO(DISABLE_PLUGIN Plugin)
    SET(${Plugin}_FORCE_DISABLE ${MENGINE_BUILD_TIMESTEMP} CACHE STRING "${Plugin}_FORCE_DISABLE" FORCE)
ENDMACRO()

MACRO(ADD_PLUGIN Plugin Toggle DLL MSG)
    IF(${Plugin}_FORCE_ENABLE AND ${Plugin}_FORCE_ENABLE STREQUAL ${MENGINE_BUILD_TIMESTEMP})
        SET(${Plugin} ON CACHE BOOL ${MSG} FORCE)
    ELSEIF(${Plugin}_FORCE_DISABLE AND ${Plugin}_FORCE_DISABLE STREQUAL ${MENGINE_BUILD_TIMESTEMP})
