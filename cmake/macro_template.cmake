...
MACRO(SET_MENGINE_ENVIRONMENT MENGINE_TARGET MENGINE_RENDER MENGINE_ARCHITECTURE MENGINE_PLATFORM MENGINE_TOOLCHAIN)    
    ...
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_TARGET_WINDOWS: ${MENGINE_TARGET_WINDOWS}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_TARGET_ANDROID: ${MENGINE_TARGET_ANDROID}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_TARGET_MACOS: ${MENGINE_TARGET_MACOS}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_TARGET_IOS: ${MENGINE_TARGET_IOS}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_RENDER_OPENGL: ${MENGINE_RENDER_OPENGL}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_RENDER_DIRECTX: ${MENGINE_RENDER_DIRECTX}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_ARCHITECTURE_X86: ${MENGINE_ARCHITECTURE_X86}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_ARCHITECTURE_X64: ${MENGINE_ARCHITECTURE_X64}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_PLATFORM_SDL: ${MENGINE_PLATFORM_SDL}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_PLATFORM_WIN32: ${MENGINE_PLATFORM_WIN32}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_TOOLCHAIN_MSVC: ${MENGINE_TOOLCHAIN_MSVC}")
    LIST(APPEND MENGINE_DEFINITIONS "MENGINE_TOOLCHAIN_MSVC: ${MENGINE_TOOLCHAIN_MSVC}")    
