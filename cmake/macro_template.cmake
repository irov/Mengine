...
MACRO(MENGINE_ADD_CONFIGURATION Definition)
    ...
    if(${num_extra_args} EQUAL 1)
        ...
        IF(PROJECT_IS_TOP_LEVEL)
            SET(MENGINE_CONFIG_CONFIGURATIONS ${MENGINE_CONFIG_CONFIGURATIONS} ${Definition} ${Value})
        ELSE()
            SET(MENGINE_CONFIG_CONFIGURATIONS ${MENGINE_CONFIG_CONFIGURATIONS} ${Definition} ${Value} PARENT_SCOPE)
        ENDIF()
    else()
        IF(PROJECT_IS_TOP_LEVEL)
            SET(MENGINE_CONFIG_CONFIGURATIONS ${MENGINE_CONFIG_CONFIGURATIONS} ${Definition} "NO-VALUE")
        ELSE()
            SET(MENGINE_CONFIG_CONFIGURATIONS ${MENGINE_CONFIG_CONFIGURATIONS} ${Definition} "NO-VALUE" PARENT_SCOPE)
        ENDIF()
    endif()
ENDMACRO()
...
MACRO(MENGINE_PROJECT name)
    IF(MENGINE_LOCAL_CONFIG_CONFIGURATIONS)
        SET(MENGINE_CONFIG_CONFIGURATIONS ${MENGINE_CONFIG_CONFIGURATIONS} ${MENGINE_LOCAL_CONFIG_CONFIGURATIONS} PARENT_SCOPE)
    ENDIF()
