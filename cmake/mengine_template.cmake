...
IF(NOT MENGINE_BUILD_VERSION MATCHES "^([0-9]+).([0-9]+).([0-9+])$")
    MESSAGE(FATAL_ERROR "Build version '${MENGINE_BUILD_VERSION}' not valid MAJOR.MINOR.PATCH value")
ENDIF()

string(REGEX MATCH "^([0-9]+)\\.([0-9]+)\\.([0-9]+)$" MENGINE_BUILD_VERSION_CHECK ${MENGINE_BUILD_VERSION})

string(REGEX MATCH "[0-9]+" MENGINE_BUILD_VERSION_MAJOR ${MENGINE_BUILD_VERSION_CHECK})
string(LENGTH ${MENGINE_BUILD_VERSION_MAJOR} MENGINE_BUILD_VERSION_MAJOR_LENGTH)
MATH(EXPR MENGINE_BUILD_VERSION_MAJOR_LENGTH "${MENGINE_BUILD_VERSION_MAJOR_LENGTH}+1")
string(SUBSTRING ${MENGINE_BUILD_VERSION_CHECK} ${MENGINE_BUILD_VERSION_MAJOR_LENGTH} -1 MENGINE_BUILD_VERSION_CHECK)
string(REGEX MATCH "[0-9]+" MENGINE_BUILD_VERSION_MINOR ${MENGINE_BUILD_VERSION_CHECK})
string(LENGTH ${MENGINE_BUILD_VERSION_MINOR} MENGINE_BUILD_VERSION_MINOR_LENGTH)
MATH(EXPR MENGINE_BUILD_VERSION_MINOR_LENGTH "${MENGINE_BUILD_VERSION_MINOR_LENGTH}+1")
string(SUBSTRING ${MENGINE_BUILD_VERSION_CHECK} ${MENGINE_BUILD_VERSION_MINOR_LENGTH} -1 MENGINE_BUILD_VERSION_CHECK)
string(REGEX MATCH "[0-9]+" MENGINE_BUILD_VERSION_PATCH ${MENGINE_BUILD_VERSION_CHECK})

IF(NOT MENGINE_BUILD_VERSION_MAJOR MATCHES "^([1-9][0-9]?[0-9]?[0-9]?)$|^0$")
    MESSAGE(FATAL_ERROR "Build version '${MENGINE_BUILD_VERSION}' not valid MAJOR value between [0-9999]")
ENDIF()

IF(NOT MENGINE_BUILD_VERSION_MINOR MATCHES "^([1-9][0-9]?)$|^0$")
    MESSAGE(FATAL_ERROR "Build version '${MENGINE_BUILD_VERSION}' not valid MINOR value between [0-99]")
ENDIF()

IF(NOT MENGINE_BUILD_VERSION_PATCH MATCHES "^([1-9][0-9]?)$|^0$")
    MESSAGE(FATAL_ERROR "Build version '${MENGINE_BUILD_VERSION}' not valid PATCH value between [0-99]")
ENDIF()
