...
set(CMAKE_C_FLAGS "/DWIN32 /D_WIN64 /D_WINDOWS /W4 /wd4481 /fsanitize=address /fsanitize=undefined")
set(CMAKE_C_FLAGS_DEBUG "${MENGINE_C_DEBUG_INFORMATION_FORMAT} /Ob0 /Od /RTC1")
set(CMAKE_C_FLAGS_RELEASE "/DNDEBUG /O2 /GL")

set(CMAKE_CXX_FLAGS "/DWIN32 /D_WIN64 /D_WINDOWS /W4 /wd4481 /wd4121 /wd4250 /wd5105 /MP /EHsc /GR /UMBCS /D_UNICODE /DUNICODE")
set(CMAKE_CXX_FLAGS_DEBUG "${MENGINE_CXX_DEBUG_INFORMATION_FORMAT} /Ob0 /Od /RTC1")
set(CMAKE_CXX_FLAGS_RELEASE "/DNDEBUG /O2 /GL")
...
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /STACK:4194304 /MANIFEST:NO /MACHINE:X64")
