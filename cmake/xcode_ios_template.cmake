...
set(CMAKE_OSX_DEPLOYMENT_TARGET "15.0" CACHE STRING "CMAKE_OSX_DEPLOYMENT_TARGET" FORCE)

set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} $(inherited) -x objective-c")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} $(inherited) -x objective-c++")
