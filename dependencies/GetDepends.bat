...
call:getdepend https://cmake.org/files/v3.5/cmake-3.7.1-win32-x86.zip cmake-3.7.1-win32-x86.zip cmake-3.7.1-win32-x86 cmake
...
call:getdepend_2 https://www.python.org/ftp/python/2.7.12/Python-2.7.12.tgz Python-2.7.12.tgz Python-2.7.12.tar Python-2.7.12 Python
