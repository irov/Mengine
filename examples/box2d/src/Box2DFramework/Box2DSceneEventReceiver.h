...
{
    //////////////////////////////////////////////////////////////////////////
    class Box2DSceneEventReceiver
        : public DummySceneEventReceiver
        , public Factorable
    {
    public:
        Box2DSceneEventReceiver();
        ~Box2DSceneEventReceiver() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<Box2DSceneEventReceiver> Box2DSceneEventReceiverPtr;
    //////////////////////////////////////////////////////////////////////////
}