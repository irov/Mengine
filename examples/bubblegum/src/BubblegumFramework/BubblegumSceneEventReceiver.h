...
{
    //////////////////////////////////////////////////////////////////////////
    class BubblegumSceneEventReceiver
        : public DummySceneEventReceiver
        , public Factorable
    {
    public:
        BubblegumSceneEventReceiver();
        ~BubblegumSceneEventReceiver() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<BubblegumSceneEventReceiver> BubblegumSceneEventReceiverPtr;
    //////////////////////////////////////////////////////////////////////////
}