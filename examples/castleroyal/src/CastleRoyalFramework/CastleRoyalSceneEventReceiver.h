...
{
    //////////////////////////////////////////////////////////////////////////
    class CastleRoyalSceneEventReceiver
        : public DummySceneEventReceiver
        , public Factorable
    {
    public:
        CastleRoyalSceneEventReceiver();
        ~CastleRoyalSceneEventReceiver() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<CastleRoyalSceneEventReceiver> CastleRoyalSceneEventReceiverPtr;
    //////////////////////////////////////////////////////////////////////////
}