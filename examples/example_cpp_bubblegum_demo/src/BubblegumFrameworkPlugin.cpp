...
{    
    ...
    {
        VOCABULARY_SET( FrameworkFactoryInterface, STRINGIZE_STRING_LOCAL( "Framework" ), STRINGIZE_STRING_LOCAL( "BubblegumFramework" ), Helper::makeFrameworkFactory<BubblegumFramework>() );
