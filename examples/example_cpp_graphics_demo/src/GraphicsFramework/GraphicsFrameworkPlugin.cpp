...
{    
    ...
    {
        VOCABULARY_SET( FrameworkFactoryInterface, STRINGIZE_STRING_LOCAL( "Framework" ), STRINGIZE_STRING_LOCAL( "VectorizatorFramework" ), Helper::makeFrameworkFactory<GraphicsFramework>( MENGINE_DOCUMENT_FACTORABLE ) );
