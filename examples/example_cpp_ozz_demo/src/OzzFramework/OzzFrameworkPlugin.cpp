...
{    
    ...
    {
        VOCABULARY_SET( FrameworkFactoryInterface, STRINGIZE_STRING_LOCAL( "Framework" ), STRINGIZE_STRING_LOCAL( "OzzFramework" ), Helper::makeFrameworkFactory<OzzFramework>( MENGINE_DOCUMENT_FACTORABLE ) );
