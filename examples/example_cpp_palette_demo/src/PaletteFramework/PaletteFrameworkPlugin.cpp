...
{    
    ...
    {
        VOCABULARY_SET( FrameworkFactoryInterface, STRINGIZE_STRING_LOCAL( "Framework" ), STRINGIZE_STRING_LOCAL( "PaletteFramework" ), Helper::makeFrameworkFactory<PaletteFramework>( MENGINE_DOCUMENT_FACTORABLE ) );
