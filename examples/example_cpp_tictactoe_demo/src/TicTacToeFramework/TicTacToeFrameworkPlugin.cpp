...
{    
    ...
    {
        VOCABULARY_SET( FrameworkFactoryInterface, STRINGIZE_STRING_LOCAL( "Framework" ), STRINGIZE_STRING_LOCAL( "TicTacToeFramework" ), Helper::makeFrameworkFactory<TicTacToeFramework>( MENGINE_DOCUMENT_FACTORABLE ) );
