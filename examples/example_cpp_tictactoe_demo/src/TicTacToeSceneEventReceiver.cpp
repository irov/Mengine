...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    void TicTacToeSceneEventReceiver::onEntityCreate( const EntityBehaviorInterfacePtr & _behavior, Entity * _entity )
    {
        MENGINE_UNUSED( _behavior );
    ...
    //////////////////////////////////////////////////////////////////////////
    void TicTacToeSceneEventReceiver::onEntityPreparation( const EntityBehaviorInterfacePtr & _behavior )
    {
        MENGINE_UNUSED( _behavior );
    ...
    //////////////////////////////////////////////////////////////////////////
    void TicTacToeSceneEventReceiver::onEntityActivate( const EntityBehaviorInterfacePtr & _behavior )
    {
        MENGINE_UNUSED( _behavior );
    ...
    void TicTacToeSceneEventReceiver::runTaskChains()
    {
        ...
        source->addWhile( [this]( const GOAP::SourcePtr & _scope_while )
        {
            ...
            for( auto && [race, hotpspot] : race_play->addParallelZip( m_hotspots ) )
            {
                ...
                race->addFunction( this, &TicTacToeSceneEventReceiver::makeTurn, cellIdx );
                race->addFunction( this, &TicTacToeSceneEventReceiver::changePlayer );
            ...
            _scope_while->addScope( this, &TicTacToeSceneEventReceiver::scopeGameOver );

            _scope_while->addFunction( this, &TicTacToeSceneEventReceiver::resetGame );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool TicTacToeSceneEventReceiver::scopeGameOver( const GOAP::SourcePtr _scope )
    {
        float delay = 100.f;
        int32_t count = 3;
        ...
        _scope->addFor( count, [this, delay]( const GOAP::SourcePtr & _scope_for, uint32_t _iterator, uint32_t _count )
        {
            ...
            _scope_for->addFunction( this, &TicTacToeSceneEventReceiver::enableSprites, false );
            _scope_for->addTask<TaskLocalDelay>( delay );
            _scope_for->addFunction( this, &TicTacToeSceneEventReceiver::enableSprites, true );
