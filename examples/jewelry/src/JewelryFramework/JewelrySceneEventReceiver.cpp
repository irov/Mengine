...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    bool JewelrySceneEventReceiver::onEntityCreate( const EntityBehaviorInterfacePtr & _behavior, Entity * _entity )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void JewelrySceneEventReceiver::onEntityDestroy( const EntityBehaviorInterfacePtr & _behavior )
    {
        MENGINE_UNUSED( _behavior );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool JewelrySceneEventReceiver::onEntityPreparation( const EntityBehaviorInterfacePtr & _behavior )
    {
        MENGINE_UNUSED( _behavior );
    ...
    //////////////////////////////////////////////////////////////////////////
    void JewelrySceneEventReceiver::makeUI_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void JewelrySceneEventReceiver::spawnJewelry_( const GOAP::SourceInterfacePtr & _source, EJewelrySuper _super, uint32_t _iterator )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void JewelrySceneEventReceiver::collapseJewelry_( const GOAP::SourceInterfacePtr & _source, const JewelryPtr & _jewelry )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void JewelrySceneEventReceiver::explosiveJewelry_( const GOAP::SourceInterfacePtr & _source, const JewelryPtr & _jewelry )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool JewelrySceneEventReceiver::onEntityActivate( const EntityBehaviorInterfacePtr & _behavior )
    {
        MENGINE_UNUSED( _behavior );
        ...
        }, [this]( const GOAP::SourceInterfacePtr & _source, uint32_t _iterator, float _time )
        {
            ...
            Cook::addScope( _source, this, &JewelrySceneEventReceiver::spawnJewelry_, EJSUPER_NORMAL, _iterator );
        } );
    ...
    //////////////////////////////////////////////////////////////////////////
    void JewelrySceneEventReceiver::onEntityDeactivate( const EntityBehaviorInterfacePtr & _behavior )
    {
        MENGINE_UNUSED( _behavior );
