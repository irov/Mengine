...
{
    //////////////////////////////////////////////////////////////////////////
    class PathfinderSceneEventReceiver
        : public DummySceneEventReceiver
        , public Factorable
    {
    public:
        PathfinderSceneEventReceiver();
        ~PathfinderSceneEventReceiver() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<PathfinderSceneEventReceiver> PathfinderSceneEventReceiverPtr;
    //////////////////////////////////////////////////////////////////////////
}