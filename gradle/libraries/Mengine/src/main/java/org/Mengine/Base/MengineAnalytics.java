...
public class MengineAnalytics {
    ...
    static public void addContextParameterBoolean(@Size(min = 1, max = 40) String key, boolean value) {
    ...
    static public void addContextParameterString(@Size(min = 1, max = 40) String key, @Size(min = 1L, max = 100L) String value) {
        MengineAnalytics.assertContext(key);
        MengineAnalytics.assertGetter(key);
    ...
    static public void addContextParameterLong(@Size(min = 1, max = 40) String key, long value) {
        MengineAnalytics.assertContext(key);
        MengineAnalytics.assertGetter(key);
    ...
    static public void addContextParameterDouble(@Size(min = 1, max = 40) String key, double value) {
        MengineAnalytics.assertContext(key);
        MengineAnalytics.assertGetter(key);
    ...
    static public void addContextGetterParameterBoolean(@Size(min = 1, max = 40) String key, MengineAnalyticsGetter<Boolean> value) {
        MengineAnalytics.assertContext(key);
        MengineAnalytics.assertGetter(key);
    ...
    static public void addContextGetterParameterString(@Size(min = 1, max = 40) String key, MengineAnalyticsGetter<String> value) {
        MengineAnalytics.assertContext(key);
        MengineAnalytics.assertGetter(key);
    ...
    static public void addContextGetterParameterLong(@Size(min = 1, max = 40) String key, MengineAnalyticsGetter<Long> value) {
        MengineAnalytics.assertContext(key);
        MengineAnalytics.assertGetter(key);
    ...
    static public void addContextGetterParameterDouble(@Size(min = 1, max = 40) String key, MengineAnalyticsGetter<Double> value) {
        MengineAnalytics.assertContext(key);
        MengineAnalytics.assertGetter(key);
    ...
    static public MengineAnalyticsEventBuilderInterface buildEvent(@Size(min = 1, max = 40) String name) {
    ...
    static public MengineAnalyticsEventBuilderInterface buildEventDummy(@Size(min = 1, max = 40) String name) {
