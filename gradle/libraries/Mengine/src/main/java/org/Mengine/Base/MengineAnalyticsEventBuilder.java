...
public class MengineAnalyticsEventBuilder implements MengineAnalyticsEventBuilderInterface {
    ...
    MengineAnalyticsEventBuilder(Map<String, Object> bases, Map<String, Object> parameters, @NonNull @Size(min = 1, max = 40) String name) {
        m_bases = bases;
    ...
    @Override
    public MengineAnalyticsEventBuilderInterface addParameterBoolean(@NonNull @Size(min = 1, max = 40) String key, boolean value) {
    ...
    @Override
    public MengineAnalyticsEventBuilderInterface addParameterString(@NonNull @Size(min = 1, max = 40) String key, @NonNull @Size(min = 0L,max = 100L) String value) {
        this.assertBases(key);
        this.assertParameters(key);
    ...
    @Override
    public MengineAnalyticsEventBuilderInterface addParameterException(@NonNull @Size(min = 1, max = 40) String key, @Nullable Exception e) {
    ...
    @Override
    public MengineAnalyticsEventBuilderInterface addParameterThrowable(@NonNull @Size(min = 1, max = 40) String key, @NonNull Throwable e) {
    ...
    @Override
    public MengineAnalyticsEventBuilderInterface addParameterJSON(@NonNull @Size(min = 1, max = 40) String key, @NonNull @Size(min = 0L,max = 100L) String value) {
    ...
    @Override
    public MengineAnalyticsEventBuilderInterface addParameterLong(@NonNull @Size(min = 1, max = 40) String key, long value) {
        this.assertBases(key);
        this.assertParameters(key);
    ...
    @Override
    public MengineAnalyticsEventBuilderInterface addParameterDouble(@NonNull @Size(min = 1, max = 40) String key, double value) {
        this.assertBases(key);
        this.assertParameters(key);
