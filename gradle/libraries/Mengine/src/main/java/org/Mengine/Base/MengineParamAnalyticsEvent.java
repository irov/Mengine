...
public class MengineParamAnalyticsEvent {
    public MengineParamAnalyticsEvent(@NonNull MengineAnalyticsEventCategory category, @NonNull String eventName, long timestamp, Map<String, Object> bases, Map<String, Object> parameters) {
    ...
    public final @NonNull String ANALYTICS_NAME;
