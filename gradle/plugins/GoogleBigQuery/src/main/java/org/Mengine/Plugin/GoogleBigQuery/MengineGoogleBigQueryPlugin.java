    ...
    public void onMengineAnalyticsEvent(MengineApplication application, int eventType, String eventName, long timestamp, Map<String, Object> parameters) {
        ...
        switch (eventType) {
            case EAET_CUSTOM: {
                ...
                this.logInfo("insertAll [CUSTOM] eventName: %s params: %s"
                    , eventName
                    , params
                );

                InsertAllResponse response =
                    m_bigQuery.insertAll(InsertAllRequest.newBuilder(tableId).addRow(params).build());
            ...
            case EAET_EARN_VIRTUAL_CURRENCY: {
                ...
                this.logInfo("insertAll [EARN_VIRTUAL_CURRENCY] eventName: %s params: %s"
                    , eventName
                    , params
                );
            ...
            case EAET_SPEND_VIRTUAL_CURRENCY: {
                ...
                this.logInfo("insertAll [SPEND_VIRTUAL_CURRENCY] eventName: %s params: %s"
                    , eventName
                    , params
                );
            ...
            case EAET_UNLOCK_ACHIEVEMENT: {
                ...
                this.logInfo("insertAll [UNLOCK_ACHIEVEMENT] eventName: %s params: %s"
                    , eventName
                    , params
                );
