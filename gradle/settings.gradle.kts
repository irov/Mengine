...
includePlugin("MENGINE_APP_PLUGIN_ADMOB_REWARDEDINTERSTITIALAD", ":plugins:AdMob:RewardedInterstitialAd", listOf("MENGINE_APP_PLUGIN_ADMOB"))
...
includePlugin("MENGINE_APP_PLUGIN_APPLOVIN_TOPPERAD", ":plugins:AppLovin:BannerAd", listOf("MENGINE_APP_PLUGIN_APPLOVIN"))
