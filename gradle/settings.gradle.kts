...
includePlugin("MENGINE_APP_PLUGIN_FIREBASE_ANALYTICS", true,":libraries:FirebaseAnalytics")
includePlugin("MENGINE_APP_PLUGIN_FIREBASE_CRASHLYTICS", true,":libraries:FirebaseCrashlytics")
includePlugin("MENGINE_APP_PLUGIN_APPLOVIN", true, ":libraries:AppLovin")
includePlugin("MENGINE_APP_PLUGIN_SENTRY",true, ":libraries:Sentry")
includePlugin("MENGINE_APP_PLUGIN_FACEBOOK", true,":libraries:Facebook")
includePlugin("MENGINE_APP_PLUGIN_DEVTODEV", true, ":libraries:DevToDev")
includePlugin("MENGINE_APP_PLUGIN_LOCAL_NOTIFICATIONS", true, ":libraries:LocalNotifications")
includePlugin("MENGINE_APP_PLUGIN_GOOGLE_SERVICE", true, ":libraries:GoogleService")
includePlugin("MENGINE_APP_PLUGIN_GOOGLE_BILLING", true, ":libraries:GoogleBilling")
includePlugin("MENGINE_APP_PLUGIN_GOOGLE_GAME_SOCIAL",true, ":libraries:GoogleGameSocial")
includePlugin("MENGINE_APP_PLUGIN_MAR", false, ":libraries:MAR")
includePlugin("MENGINE_APP_PLUGIN_ADJUST", false, ":libraries:Adjust")
includePlugin("MENGINE_APP_PLUGIN_GOOGLE_INAPP_REVIEWS",true, ":libraries:GoogleInAppReviews")
