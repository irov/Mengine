...
namespace	mt
{
	...
	bool	simplex_solver::update( mt::vec3f & V )
	{
		bool found = false; 
	...
	void	simplex_solver::remove( int _size )
	{
		assert( _size );
	...
	bool	simplex_solver::solve( mt::vec3f AO, mt::vec3f AB, mt::vec3f & V )
	{
	...
	bool	simplex_solver::solve( mt::vec3f AO, mt::vec3f AB, mt::vec3f AC, mt::vec3f & V )
	{
