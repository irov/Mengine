...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL3Application::initializeOptionsService_( int32_t _argc, Char ** const _argv )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL3Application::initializeLoggerService_()
    {
        if( LOGGER_SERVICE()
            ->isSilent() == true )
        {
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL3Application::finalizeLoggerService_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL3Application::bootstrap( int32_t _argc, Char ** const _argv )
    {
#if defined(MENGINE_PLUGIN_MENGINE_SHARED)
#   error "MENGINE_PLUGIN_MENGINE_SHARED for SDL3 not implemented"
        ...
        SERVICE_PROVIDER_GET()->waitService( "SDL3Application", SERVICE_ID( OptionsServiceInterface ), [this, _argc, _argv]()
        {
        ...
        UNKNOWN_SERVICE_WAIT( SDL3Application, LoggerServiceInterface, [this]()
        {
        ...
        UNKNOWN_SERVICE_LEAVE( SDL3Application, LoggerServiceInterface, [this]()
        {
...
#error "MENGINE_PLUGIN_MENGINE_SHARED for SDL2 not implemented"
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL3Application::loop()
    {
        PLATFORM_SERVICE()
            ->loopPlatform();
    }
    //////////////////////////////////////////////////////////////////////////
    void SDL3Application::finalize()
    {
