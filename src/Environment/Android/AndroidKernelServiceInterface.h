...
namespace Mengine
{
    ...
    public:
        virtual void stringize( MengineJNIEnvThread * _jenv, jstring _value, ConstString * const _cstr ) = 0;
    ...
    public:
        ...
        virtual void callPluginMethod( MengineJNIEnvThread * _jenv, const ConstString & _plugin, const ConstString & _method, jobjectArray _args ) const = 0;
