...
#   define IOS_LOGGER_INFO( Category, ... ) [iOSLog logWithCategory:Category level:Mengine::LM_INFO flag:Mengine::LFLAG_SHORT filter:Mengine::LFILTER_NONE color:(Mengine::LCOLOR_BLUE) file:@(MENGINE_CODE_FILE) line:(MENGINE_CODE_LINE) function:@(MENGINE_CODE_FUNCTION) format:__VA_ARGS__]
#else
...
#   define IOS_LOGGER_INFO( Category, ... )
#endif
