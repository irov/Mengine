...
- (instancetype _Nonnull)initFromUserDefaults {
    ...
    self.TRANSPARENCYCONSENT_USENONSTANDARDSTACKS = [defaults integerForKey:@"IABTCF_UseNonStandardStacks"];
    ...
    self.TRANSPARENCYCONSENT_VENDORLEGITIMATEINTERESTS = [defaults stringForKey:@"IABTCF_VendorLegitimateInterests"] ?: @"";
