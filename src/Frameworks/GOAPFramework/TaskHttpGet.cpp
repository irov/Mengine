...
{    
    //////////////////////////////////////////////////////////////////////////
    TaskHttpGet::TaskHttpGet( GOAP::Allocator * _allocator, const String & _url, const HttpRequestHeaders & _headers, int32_t _timeout, bool _receiveHeaders, const HttpTaskReceiverInterfacePtr & _receiver )
    ...
    //////////////////////////////////////////////////////////////////////////
    bool TaskHttpGet::_onRun( GOAP::NodeInterface * _node )
    {
