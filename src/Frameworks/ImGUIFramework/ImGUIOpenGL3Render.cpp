...
//  2026-03-12: OpenGL: Fixed invalid assert in MengineImGUIOpenGL3Render_UpdateTexture() if ImTextureID_Invalid is defined to be != 0, which became the default since 2026-03-12. (#9295)
//  2025-12-11: OpenGL: Fixed embedded loader multiple init/shutdown cycles broken on some platforms. (#8792, #9112)
//  2025-09-18: Call platform_io.ClearRendererHandlers() on shutdown.
//  2025-07-22: OpenGL: Add and call embedded loader shutdown during MengineImGUIOpenGL3Render_Shutdown() to facilitate multiple init/shutdown cycles in same process. (#8792)
...
//  2025-06-11: OpenGL: Added support for ImGuiBackendFlags_RendererHasTextures, for dynamic font atlas. Removed MengineImGUIOpenGL3Render_CreateFontsTexture() and MengineImGUIOpenGL3Render_DestroyFontsTexture().
...
//  2024-06-28: OpenGL: MengineImGUIOpenGL3Render_NewFrame() recreates font texture if it has been destroyed by MengineImGUIOpenGL3Render_DestroyFontsTexture(). (#7748)
...
//  2019-09-16: OpenGL: Tweak initialization code to allow application calling MengineImGUIOpenGL3Render_CreateFontsTexture() before the first NewFrame() call.
//  2019-05-29: OpenGL: Desktop GL only: Added support for large mesh (64K+ vertices), enable ImGuiBackendFlags_RendererHasVtxOffset flag.
//  2019-04-30: OpenGL: Added support for special ImDrawCallback_ResetRenderState callback to reset render state.
//  2019-03-29: OpenGL: Not calling glBindBuffer more than necessary in the render loop.
//  2019-03-15: OpenGL: Added a GL call + comments in MengineImGUIOpenGL3Render_Init() to detect uninitialized GL function loaders early.
...
//  2018-06-08: Misc: Extracted the OpenGL3 renderer away from the old combined platform examples.
//  2018-06-08: OpenGL: Use draw_data->DisplayPos and draw_data->DisplaySize to setup projection matrix and clipping rectangle.
//  2018-05-25: OpenGL: Removed unnecessary backup/restore of GL_ELEMENT_ARRAY_BUFFER_BINDING since this is part of the VAO state.
//  2018-05-14: OpenGL: Making the call to glBindSampler() optional so 3.2 context won't fail if the function is a nullptr pointer.
//  2018-03-06: OpenGL: Added const char* glsl_version parameter to MengineImGUIOpenGL3Render_Init() so user can override the GLSL version e.g. "#version 150".
//  2018-02-23: OpenGL: Create the VAO in the render function so the setup can more easily be used with multiple shared GL context.
//  2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn callback and exposed the renderer callback in the header.
//  2018-01-07: OpenGL: Changed GLSL shader version from 330 to 150.
//  2017-09-01: OpenGL: Save and restore current bound sampler. Save and restore current polygon mode.
//  2017-05-01: OpenGL: Fixed save and restore of current blend func state.
//  2017-05-01: OpenGL: Fixed save and restore of current GL_ACTIVE_TEXTURE.
//  2016-09-05: OpenGL: Fixed save and restore of current scissor rectangle.
//  2016-07-29: OpenGL: Explicitly setting GL_UNPACK_ROW_LENGTH because windowing backends may change it. (#752)
...
// OpenGL Data
struct MengineImGUIOpenGL3Render_Data
{
    ...
    MengineImGUIOpenGL3Render_Data() { memset((void*)this, 0, sizeof(*this)); }
};

// Backend data stored in io.BackendRendererUserData to allow support for multiple Dear ImGui contexts
// It is STRONGLY preferred that you use docking branch with multi-viewports (== single Dear ImGui context + multiple windows) instead of multiple Dear ImGui contexts.
static MengineImGUIOpenGL3Render_Data* MengineImGUIOpenGL3Render_GetBackendData()
{
    return ImGui::GetCurrentContext() ? (MengineImGUIOpenGL3Render_Data*)ImGui::GetIO().BackendRendererUserData : nullptr;
}

// Forward Declarations
static void MengineImGUIOpenGL3Render_InitMultiViewportSupport();
static void MengineImGUIOpenGL3Render_ShutdownMultiViewportSupport();

// OpenGL vertex attribute state (for ES 1.0 and ES 2.0 only)
#ifndef IMGUI_IMPL_OPENGL_USE_VERTEX_ARRAY
struct MengineImGUIOpenGL3Render_VtxAttribState
{
...
bool MengineImGUIOpenGL3Render_InitLoader();
bool MengineImGUIOpenGL3Render_InitLoader()
{
...
static void MengineImGUIOpenGL3Render_ShutdownLoader()
{
#ifdef IMGUI_IMPL_OPENGL_LOADER_IMGL3W
    imgl3wShutdown();
#endif
...
// Functions
void    MengineImGUIOpenGL3Render_NewFrame()
{
    MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData();
    IM_ASSERT(bd != nullptr && "Context or backend not initialized! Did you call MengineImGUIOpenGL3Render_Init()?");

    MengineImGUIOpenGL3Render_InitLoader();
    if (!bd->ShaderHandle)
        if (!MengineImGUIOpenGL3Render_CreateDeviceObjects())
            IM_ASSERT(0 && "MengineImGUIOpenGL3Render_CreateDeviceObjects() failed!");
}

static void MengineImGUIOpenGL3Render_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
    MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData();
...
// Draw callbacks
static void MengineImGUIOpenGL3Render_DrawCallback_ResetRenderState(const ImDrawList*, const ImDrawCmd*)    {} // Intentionally empty. Used as an identifier for rendering loop to call its code. Simpler to implement this way.
#ifdef IMGUI_IMPL_OPENGL_MAY_HAVE_BIND_SAMPLER
static void MengineImGUIOpenGL3Render_DrawCallback_SetSamplerLinear(const ImDrawList*, const ImDrawCmd*)    { MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData(); if (bd->HasBindSampler) { glBindSampler(0, bd->TexSamplers[0]); } else { bd->UseTexParameterToSetSampler = true; bd->NextSampler = GL_LINEAR; } }
static void MengineImGUIOpenGL3Render_DrawCallback_SetSamplerNearest(const ImDrawList*, const ImDrawCmd*)   { MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData(); if (bd->HasBindSampler) { glBindSampler(0, bd->TexSamplers[1]); } else { bd->UseTexParameterToSetSampler = true; bd->NextSampler = GL_NEAREST; } }
#else
static void MengineImGUIOpenGL3Render_DrawCallback_SetSamplerLinear(const ImDrawList*, const ImDrawCmd*)    { MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData(); bd->UseTexParameterToSetSampler = true; bd->NextSampler = GL_LINEAR; }
static void MengineImGUIOpenGL3Render_DrawCallback_SetSamplerNearest(const ImDrawList*, const ImDrawCmd*)   { MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData(); bd->UseTexParameterToSetSampler = true; bd->NextSampler = GL_NEAREST; }
#endif

// OpenGL3 Render function.
// Note that this implementation is little overcomplicated because we are saving/setting up/restoring every OpenGL state explicitly.
// This is in order to be able to run within an OpenGL engine that doesn't do so.
void    MengineImGUIOpenGL3Render_RenderDrawData(ImDrawData* draw_data)
{
    ...
    if (draw_data->Textures != nullptr)
        for (ImTextureData* tex : *draw_data->Textures)
            if (tex->Status != ImTextureStatus_OK)
                MengineImGUIOpenGL3Render_UpdateTexture(tex);
    ...
    MengineImGUIOpenGL3Render_VtxAttribState last_vtx_attrib_state_pos; last_vtx_attrib_state_pos.GetState(bd->AttribLocationVtxPos);
    MengineImGUIOpenGL3Render_VtxAttribState last_vtx_attrib_state_uv; last_vtx_attrib_state_uv.GetState(bd->AttribLocationVtxUV);
    MengineImGUIOpenGL3Render_VtxAttribState last_vtx_attrib_state_color; last_vtx_attrib_state_color.GetState(bd->AttribLocationVtxColor);
#endif
#ifdef IMGUI_IMPL_OPENGL_USE_VERTEX_ARRAY
...
#endif
    MengineImGUIOpenGL3Render_SetupRenderState(draw_data, fb_width, fb_height, vertex_array_object);
    ...
    for (const ImDrawList* draw_list : draw_data->CmdLists)
    {
        ...
        for (int cmd_i = 0; cmd_i < draw_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            if (pcmd->UserCallback != nullptr)
            {
                ...
                if (pcmd->UserCallback == MengineImGUIOpenGL3Render_DrawCallback_ResetRenderState)
                    MengineImGUIOpenGL3Render_SetupRenderState(draw_data, fb_width, fb_height, vertex_array_object);
                else
...
static void MengineImGUIOpenGL3Render_DestroyTexture(ImTextureData* tex)
{
...
void MengineImGUIOpenGL3Render_UpdateTexture(ImTextureData* tex)
{
    ...
    else if (tex->Status == ImTextureStatus_WantUpdates)
    {
        ...
        MengineImGUIOpenGL3Render_DestroyTexture(tex);
}
...
static bool CheckShader(GLuint handle, const char* desc)
{
    ...
    if ((GLboolean)status == GL_FALSE)
        fprintf(stderr, "ERROR: MengineImGUIOpenGL3Render_CreateDeviceObjects: failed to compile %s! With GLSL: %s\n", desc, bd->GlslVersionString);
    if (log_length > 1)
    {
        ImVector<char> buf;
...
static bool CheckProgram(GLuint handle, const char* desc)
{
    ...
    if ((GLboolean)status == GL_FALSE)
        fprintf(stderr, "ERROR: MengineImGUIOpenGL3Render_CreateDeviceObjects: failed to link %s! With GLSL %s\n", desc, bd->GlslVersionString);
    if (log_length > 1)
    {
        ImVector<char> buf;
        buf.resize((int)(log_length + 1));
...
bool    MengineImGUIOpenGL3Render_CreateDeviceObjects()
{
    MengineImGUIOpenGL3Render_InitLoader();
    MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData();
...
void    MengineImGUIOpenGL3Render_DestroyDeviceObjects()
{
    MengineImGUIOpenGL3Render_InitLoader();
    MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData();
#ifdef IMGUI_IMPL_OPENGL_MAY_HAVE_BIND_SAMPLER
...
bool    MengineImGUIOpenGL3Render_Init(const char* glsl_version)
{
    ...
    // Initialize loader
    if (!MengineImGUIOpenGL3Render_InitLoader())
        return false;

    // Setup backend capabilities flags
    MengineImGUIOpenGL3Render_Data* bd = IM_NEW(MengineImGUIOpenGL3Render_Data)();
    io.BackendRendererUserData = (void*)bd;
    io.BackendRendererName = "mengine_imgui_opengl3";
    ...
    */
    ...
    platform_io.DrawCallback_ResetRenderState = MengineImGUIOpenGL3Render_DrawCallback_ResetRenderState;
    platform_io.DrawCallback_SetSamplerLinear = MengineImGUIOpenGL3Render_DrawCallback_SetSamplerLinear;
    platform_io.DrawCallback_SetSamplerNearest = MengineImGUIOpenGL3Render_DrawCallback_SetSamplerNearest;
    ...
    MengineImGUIOpenGL3Render_InitMultiViewportSupport();

    return true;
}

void    MengineImGUIOpenGL3Render_Shutdown()
{
    MengineImGUIOpenGL3Render_Data* bd = MengineImGUIOpenGL3Render_GetBackendData();
    ...
    MengineImGUIOpenGL3Render_ShutdownMultiViewportSupport();
    ...
    MengineImGUIOpenGL3Render_ShutdownLoader();
}
...
static void MengineImGUIOpenGL3Render_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    MengineImGUIOpenGL3Render_RenderDrawData(viewport->DrawData);
}

static void MengineImGUIOpenGL3Render_InitMultiViewportSupport()
{
    ImGuiPlatformIO& platform_io = ImGui::GetPlatformIO();
    platform_io.Renderer_RenderWindow = MengineImGUIOpenGL3Render_RenderWindow;
}
