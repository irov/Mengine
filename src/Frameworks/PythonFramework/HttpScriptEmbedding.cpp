...
{    
    //////////////////////////////////////////////////////////////////////////
    HttpScriptEmbedding::HttpScriptEmbedding()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    HttpScriptEmbedding::~HttpScriptEmbedding()
    ...
    //////////////////////////////////////////////////////////////////////////
    bool HttpScriptEmbedding::embed( pybind::kernel_interface * _kernel )
    {
        ...
        pybind::def_functor_args( _kernel, "getMessage", this, &HttpScriptEmbedding::getMessage );
        pybind::def_functor_args( _kernel, "postMessage", this, &HttpScriptEmbedding::postMessage );
        pybind::def_functor_args( _kernel, "headerData", this, &HttpScriptEmbedding::headerData );
    ...
    //////////////////////////////////////////////////////////////////////////
    void HttpScriptEmbedding::eject( pybind::kernel_interface * _kernel )
    {
