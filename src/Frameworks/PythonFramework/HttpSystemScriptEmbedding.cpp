#include "HttpSystemScriptEmbedding.h"
...
{    
    //////////////////////////////////////////////////////////////////////////
    HttpSystemScriptEmbedding::HttpSystemScriptEmbedding()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    HttpSystemScriptEmbedding::~HttpSystemScriptEmbedding()
    ...
    //////////////////////////////////////////////////////////////////////////
    HttpRequestId HttpSystemScriptEmbedding::downloadAsset( const String & _url, const String & _login, const String & _password, const ConstString & _fileGroupName, const FilePath & _filePath, int32_t _timeout, const pybind::object & _cb, const pybind::args & _args )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    HttpRequestId HttpSystemScriptEmbedding::getMessage( const String & _url, int32_t _timeout, const pybind::object & _cb, const pybind::args & _args )
    {
        PyHttpReceiverPtr receiver = m_factoryPyHttpReceiver->createObject( MENGINE_DOCUMENT_PYBIND );
    ...
    //////////////////////////////////////////////////////////////////////////
    void HttpSystemScriptEmbedding::cancelRequest( HttpRequestId _id )
    {
        HTTP_SYSTEM()
            ->cancelRequest( _id );
    }
    //////////////////////////////////////////////////////////////////////////
    bool HttpSystemScriptEmbedding::embed( pybind::kernel_interface * _kernel )
    {
        ...
        pybind::def_functor_args( _kernel, "getMessage", this, &HttpSystemScriptEmbedding::getMessage );
        pybind::def_functor_args( _kernel, "postMessage", this, &HttpSystemScriptEmbedding::postMessage );
        pybind::def_functor_args( _kernel, "headerData", this, &HttpSystemScriptEmbedding::headerData );
        pybind::def_functor_args( _kernel, "downloadAsset", this, &HttpSystemScriptEmbedding::downloadAsset );
        pybind::def_functor( _kernel, "cancelRequest", this, &HttpSystemScriptEmbedding::cancelRequest );
    ...
    //////////////////////////////////////////////////////////////////////////
    void HttpSystemScriptEmbedding::eject( pybind::kernel_interface * _kernel )
    {
