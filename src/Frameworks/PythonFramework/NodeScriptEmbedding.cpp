...
namespace Mengine
{
    ...
    bool NodeScriptEmbedding::embed( pybind::kernel_interface * _kernel )
    {
...

        {
            ...
            pybind::enum_<EVirtualAreaSnappingMode>( _kernel, "EVirtualAreaSnappingMode" )
                .def( "EVASM_NONE", EVASM_NONE )
                .def( "EVASM_HORIZONTAL", EVASM_HORIZONTAL )
                .def( "EVASM_VERTICAL", EVASM_VERTICAL )
                ;
            ...
            pybind::interface_<VirtualArea, pybind::bases<Node>>( _kernel, "VirtualArea", false )
                ...
                .def( "setVirtualAreaFrictionBase", &VirtualArea::setFrictionBase )
                .def( "getVirtualAreaFrictionBase", &VirtualArea::getFrictionBase )
                .def( "setVirtualAreaFrictionFactor", &VirtualArea::setFrictionFactor )
                .def( "getVirtualAreaFrictionFactor", &VirtualArea::getFrictionFactor )
                ...
                .def( "setVirtualAreaDragInvertedX", &VirtualArea::setDragInvertedX )
                .def( "getVirtualAreaDragInvertedX", &VirtualArea::getDragInvertedX )
                .def( "setVirtualAreaDragInvertedY", &VirtualArea::setDragInvertedY )
                .def( "getVirtualAreaDragInvertedY", &VirtualArea::getDragInvertedY )
                ...
                .def( "isVirtualAreaScrollLocked", &VirtualArea::isScrollLocked )
                .def( "setVirtualAreaFrozen", &VirtualArea::freeze )
                .def( "isVirtualAreaFrozen", &VirtualArea::isFrozen )
                .def( "setVirtualAreaSnappingMode", &VirtualArea::setSnappingMode )
                .def( "getVirtualAreaSnappingMode", &VirtualArea::getSnappingMode )
                .def( "setVirtualAreaSnappingBoundsPoint", &VirtualArea::setSnappingBoundsPoint )
                .def( "getVirtualAreaSnappingBoundsPoint", &VirtualArea::getSnappingBoundsPoint )
                .def( "clearVirtualAreaSnappingPoints", &VirtualArea::clearSnappingPoints )
                .def( "addVirtualAreaSnappingPoint", &VirtualArea::addSnappingPoint )
                .def( "getVirtualAreaSnappingPointCount", &VirtualArea::getSnappingPointCount )
                .def( "setVirtualAreaSnappingCoefficient", &VirtualArea::setSnappingCoefficient )
                .def( "getVirtualAreaSnappingCoefficient", &VirtualArea::getSnappingCoefficient )
                .def( "setVirtualAreaSnappingEpsilon", &VirtualArea::setSnappingEpsilon )
                .def( "getVirtualAreaSnappingEpsilon", &VirtualArea::getSnappingEpsilon )
                ...
                .def( "getVirtualAreaLocalBounds", &VirtualArea::getLocalBounds )
