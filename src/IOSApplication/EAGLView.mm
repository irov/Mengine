...
#import "Interface/InputSystemInterface.h"
...
- ( void )touchesBegan : ( NSSet * )touches withEvent : ( UIEvent * )event
{
    ...
    Menge::ServiceProviderInterface * serviceProvider = app->getServiceProvider();
    Menge::InputServiceInterface * inputSevice = serviceProvider->getServiceT<Menge::InputServiceInterface>( "InputService" );
	...
	for( UITouch * touch in touches )
	{
        ...
        //pApplication->setCursorPosition( p );
        inputSevice->onMouseButtonEvent( i, p, 0, true );
...
- ( void )touchesMoved : ( NSSet * )touches withEvent : ( UIEvent * )event
{
	...
	for( UITouch * touch in touches )
	{
        ...
        //pApplication->setCursorPosition( p );
        inputSevice->onMouseMove( i, p, p.x - old[ i ].x, p.y - old[ i ].y, 0 );
...
- ( void )touchesEnded : ( NSSet * )touches withEvent : ( UIEvent * )event
{
	...
	for( UITouch * touch in touches )
	{
        ...
        //pApplication->setCursorPosition( p );
        inputSevice->onMouseButtonEvent( i, p, 0, false );
...
- (void)deleteBackward
{
    ...
    if( pApplication != 0 )
    {
        ...
        inputSevice->onKeyEvent( old[ 0 ], 0x08, 0x08, true );
        inputSevice->onKeyEvent( old[ 0 ], 0x08, 0x08, false );
    }
}
...
- (void)insertText:(NSString *)text
{
    ...
    {        
        ...
        inputSevice->onKeyEvent( old[ 0 ], GetMSVirtualKey( symbol ), symbol, true );
        inputSevice->onKeyEvent( old[ 0 ], GetMSVirtualKey( symbol ), symbol, false );
    }
}
