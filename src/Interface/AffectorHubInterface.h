...
namespace Mengine
{
    ...
    public:
        virtual AFFECTOR_ID addAffector( const AffectorPtr & _affector ) = 0;
        virtual bool hasAffector( AFFECTOR_ID _id ) const = 0;
        virtual bool stopAffector( AFFECTOR_ID _id ) = 0;
