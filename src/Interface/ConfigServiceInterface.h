...
#define CONFIG_VALUE( section, key, default )\
	([]() -> const decltype(Mengine::decltype_string(default)) &{ static decltype(Mengine::decltype_string( default )) value = SERVICE_IS_INITIALIZE(ConfigServiceInterface) == true ? CONFIG_SERVICE()->getDefaultConfig()->getValue( section, key, default ) : default;return value;}())
////////////////////////////////////////////////////////////////////////////
#define CONFIG_VALUE2( section, key, default )\
	([default]() -> const decltype(Mengine::decltype_string(default)) &{ static decltype(Mengine::decltype_string(default)) value = SERVICE_IS_INITIALIZE(ConfigServiceInterface) == true ? CONFIG_SERVICE()->getDefaultConfig()->getValue( section, key, default ) : default; return value;}())
//////////////////////////////////////////////////////////////////////////
