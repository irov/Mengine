...
namespace Mengine
{
    ...
    public:
        ...
        virtual String getValue( const Char * _section, const Char * _key, const String & _default ) const = 0;
...
#define CONFIG_VALUE( section, key, default )\
	([]() -> const decltype(default) &{ static decltype(default) value = CONFIG_SERVICE()->getValue( section, key, default ); return value;}())
//////////////////////////////////////////////////////////////////////////
