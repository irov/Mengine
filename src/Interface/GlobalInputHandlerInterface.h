...
namespace Mengine
{
    ...
    public:
        virtual uint32_t addGlobalHandler( const InputHandlerInterfacePtr & _handler, const DocumentPtr & _doc ) = 0;
    ...
    public:
        ...
        virtual uint32_t addGlobalKeyHandler( EKeyCode _code, const LambdaKeyHandler & _lambda, const DocumentPtr & _doc ) = 0;
