...
#define MENGINE_DECLARE_NOTIFICATOR(ID, NAME, ...)\
    ...
    MENGINE_DECLARE_NOTIFICATOR( 3, NOTIFICATOR_DEBUG_FACTORY_CREATE_OBJECT, Factory *, Factorable *, const Char * );
    MENGINE_DECLARE_NOTIFICATOR( 4, NOTIFICATOR_DEBUG_FACTORY_DESTROY_OBJECT, Factory *, Factorable * );
