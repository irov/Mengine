...
#define MENGINE_NOTIFICATOR_DECLARE(NAME, ...)\
    ...
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_ASSERTION, EAssertionLevel, const Char *, const Char *, int32_t, const Char * );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_ABORT, const Char * );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_CRASH, const Char * );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_ERROR, EErrorLevel, const Char *, int32_t, const Char * );
    ...
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_APPLICATION_RUN );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_APPLICATION_READY );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_APPLICATION_STOP );
