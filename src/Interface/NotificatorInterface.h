...
#define MENGINE_NOTIFICATOR_DECLARE(NAME, ...)\
    ...
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_CHANGE_TEXT_ALIAS_ID, const ConstString &, const ConstString & );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_CHANGE_TEXT_ALIAS_ARGUMENTS, const ConstString &, const ConstString & );
    ...
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_BOOTSTRAPPER_INITIALIZE_COMPLETE );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_BOOTSTRAPPER_RUN );
    ...
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_MODULE_INITIALIZE, const ConstString & );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_MODULE_FINALIZE, const ConstString & );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_PLUGIN_INITIALIZE, const ConstString & );
    MENGINE_NOTIFICATOR_DECLARE( NOTIFICATOR_PLUGIN_FINALIZE, const ConstString & );
