...
#define MENGINE_DECLARE_NOTIFICATOR(NAME, ...)\
    ...
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_ENGINE_STOP_SERVICES );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_ENGINE_STOP_THREADS );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_ENABLE_PACKAGES, const ConstString & , const Tags & );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_RENDER_TEXTURE_DESTROY, RenderTextureInterface * );
    ...
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_APPLICATION_READY );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_APPLICATION_STOP );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_APPLICATION_BEGIN_UPDATE );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_APPLICATION_END_UPDATE );
    ...
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_IOS_APPLICATION_DID_BECOME_ACTIVE );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_IOS_APPLICATION_WILL_ENTER_FOREGROUND );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_IOS_APPLICATION_DID_ENTER_BACKGROUD );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_IOS_APPLICATION_WILL_RESIGN_ACTIVE );
    MENGINE_DECLARE_NOTIFICATOR( NOTIFICATOR_IOS_APPLICATION_WILL_TERMINATE );
#endif
    MENGINE_DECLARE_END();
    //////////////////////////////////////////////////////////////////////////
