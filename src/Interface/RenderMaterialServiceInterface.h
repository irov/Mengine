...
namespace Mengine
{
    ...
    public:
        ...
        virtual void removeVertexAttribute( const ConstString & _name ) = 0;
        ...
        virtual void removeVertexShader( const ConstString & _name ) = 0;
        ...
        virtual void removeFragmentShader( const ConstString & _name ) = 0;
        ...
        virtual void removeProgram( const ConstString & _name ) = 0;
