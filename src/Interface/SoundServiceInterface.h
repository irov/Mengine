...
namespace Mengine
{
    ...
    public:
        virtual SoundBufferInterfacePtr createSoundBufferFromFile( const FileGroupInterfacePtr & _fileGroup, const FilePath & _filePath, const ConstString & _codecType, bool _isStream, const Char * _doc ) = 0;
