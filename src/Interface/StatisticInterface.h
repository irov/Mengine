...
#define MENGINE_STATISTIC_DECLARE(NAME, ENABLED)\
    ...
    MENGINE_STATISTIC_DECLARE( STATISTIC_HTTP_RESPONSE_COUNT, true );
    ...
    MENGINE_STATISTIC_DECLARE( STATISTIC_RENDER_TEXTURE_UNLOCK_COUNT, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_RENDER_TEXTURE_UNLOCK_PIXEL, true );
    ...
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_PEER_COUNT, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_BYTES_SENT, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_BYTES_RECEIVED, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_PACKETS_SENT, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_PACKETS_RECEIVED, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_PACKETS_RETRANSMITTED, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_PACKETS_REJECTED, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_PENDING_RELIABLE_PACKETS, true );
    MENGINE_STATISTIC_DECLARE( STATISTIC_SOCKET_PEER_RTT_MS, true );
