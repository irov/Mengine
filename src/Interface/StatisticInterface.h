...
#define MENGINE_STATISTIC_DECLARE(NAME)\
    ...
    MENGINE_STATISTIC_DECLARE( STATISTIC_FILE_OPEN_COUNT );
    MENGINE_STATISTIC_DECLARE( STATISTIC_FILE_READ_BYTES );
    MENGINE_STATISTIC_DECLARE( STATISTIC_FILE_WRITE_BYTES );
    MENGINE_STATISTIC_DECLARE( STATISTIC_HTTP_REQUEST_COUNT );
