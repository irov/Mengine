...
#   define UNICODE_SYSTEM( serviceProvider )\
    ...
    namespace Helper
    {
        ...
        //////////////////////////////////////////////////////////////////////////
        inline bool utf8ToUnicode( ServiceProviderInterface * _serviceProvide, const PathString & _utf8, WString & _unicode )
        {
            bool result = utf8ToUnicodeSize( _serviceProvide, _utf8.c_str(), _utf8.size(), _unicode );
        ...
        //////////////////////////////////////////////////////////////////////////
        inline bool utf8ToUnicode( ServiceProviderInterface * _serviceProvide, const FilePath & _utf8, WString & _unicode )
        {
            bool result = utf8ToUnicodeSize( _serviceProvide, _utf8.c_str(), _utf8.size(), _unicode );
