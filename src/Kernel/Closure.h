...
namespace Mengine
{
    ...
    public:
        ...
        auto operator () ( Args && ... _args ) const
        {
            ...
            return std::apply( m_method, std::tuple_cat( std::make_tuple( ptr ), std::tuple_cat( std::make_tuple( _args ... ), m_forwards ) ) );
        }
    ...
    namespace Helper
    {
        ...
        {
            return ClosurePtr<P, D, M, Tuple<Forwards ...>>( _ptr, _method, std::make_tuple( _args ... ) );
        }
    }
}