...
namespace Mengine
{
    ...
    public:
        ...
        void onGameCreateAccount( const AccountInterfacePtr & _account, bool _global ) override;
        void onGameDeleteAccount( const AccountInterfacePtr & _account ) override;
        void onGameSelectAccount( const AccountInterfacePtr & _account ) override;
        void onGameUnselectAccount( const AccountInterfacePtr & _account ) override;
