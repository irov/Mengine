...
#define LOGGER_MESSAGE_PROTECTED( ... ) LOGGER_CATEGORY_VERBOSE_LEVEL( Mengine::LM_MESSAGE, Mengine::LFILTER_PROTECTED, Mengine::LCOLOR_RED | Mengine::LCOLOR_BLUE, Mengine::LFLAG_SHORT ) LOGGER_CALL_MESSAGE_FORMAT( __VA_ARGS__ )
