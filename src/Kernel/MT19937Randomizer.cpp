...
namespace Mengine
{
    ...
    {
        MENGINE_ASSERTION_FATAL( _min <= _max, "invalid range min %" MENGINE_PRIu32 " max %" MENGINE_PRIu32
            , _min
            , _max
        );
    ...
    {
        MENGINE_ASSERTION_FATAL( _min <= _max, "invalid range min %" MENGINE_PRId32 " max %" MENGINE_PRId32
            , _min
            , _max
        );
    ...
    {
        MENGINE_ASSERTION_FATAL( _min <= _max, "invalid range min %" MENGINE_PRIu64 " max %" MENGINE_PRIu64
            , _min
            , _max
        );
    ...
    {
        MENGINE_ASSERTION_FATAL( _min <= _max, "invalid range min %" MENGINE_PRId64 " max %" MENGINE_PRId64
            , _min
            , _max
        );
    ...
    {
        MENGINE_ASSERTION_FATAL( _min <= _max, "invalid range min %f max %f"
            , _min
            , _max
        );
    ...
    {
        MENGINE_ASSERTION_FATAL( _min <= _max, "invalid range min %lf max %lf"
            , _min
            , _max
        );
