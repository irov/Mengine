...
namespace Menge
{
	...
	namespace Helper
	{
		...
		RenderMaterialInterfacePtr makeTextureMaterial( ServiceProviderInterface * _serviceProvider, const RenderTextureInterfacePtr * _textures, size_t _textureCount, const ConstString & _materialName, EMaterialBlendMode _blend, bool _disableTextureColor, bool _solid );
	}
	...
	protected:
		...
		RenderMaterialInterfacePtr makeTextureMaterial( ServiceProviderInterface * _serviceProvider, const RenderTextureInterfacePtr * _textures, size_t _textureCount, bool _solid ) const;
