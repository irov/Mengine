#include "MixerMultiplicative.h"

namespace Mengine
{
    //////////////////////////////////////////////////////////////////////////
    MixerMultiplicative::MixerMultiplicative()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    MixerMultiplicative::~MixerMultiplicative()
    ...
    //////////////////////////////////////////////////////////////////////////
    void MixerMultiplicative::setValue( const ConstString & _type, float _value, float _from, float _speed, bool _force )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    float MixerMultiplicative::getValue( const ConstString & _type ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    float MixerMultiplicative::mixValue() const
    {
        float mix = 1.f;
    ...
    //////////////////////////////////////////////////////////////////////////
    bool MixerMultiplicative::update( const UpdateContext * _context )
    {
        bool process = false;
