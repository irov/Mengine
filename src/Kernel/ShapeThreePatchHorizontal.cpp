#include "ShapeThreePatchHorizontal.h"
...
namespace Mengine
{
    ...
    {
        //////////////////////////////////////////////////////////////////////////
        static const RenderIndex SHAPE_THREE_PATCH_HORIZONTAL_INDICES[18] = {
            0, 1, 5, 0, 5, 4,
            1, 2, 6, 1, 6, 5,
            2, 3, 7, 2, 7, 6,
        };
    ...
    //////////////////////////////////////////////////////////////////////////
    ShapeThreePatchHorizontal::ShapeThreePatchHorizontal()
        : m_size( -1.f, -1.f )
        , m_capInsets( 0.f, 0.f )
    {
    }
    ...
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::setSize( const mt::vec2f & _size )
    {
        if( m_size == _size )
        {
            return;
    ...
    //////////////////////////////////////////////////////////////////////////
    const mt::vec2f & ShapeThreePatchHorizontal::getSize() const
    {
        return m_size;
    }
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::removeSize()
    {
        this->setSize( mt::vec2f( -1.f, -1.f ) );
    }
    //////////////////////////////////////////////////////////////////////////
    bool ShapeThreePatchHorizontal::hasSize() const
    {
        return m_size.x >= 0.f || m_size.y >= 0.f;
    }
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::setCapInsets( const mt::vec2f & _capInsets )
    {
        mt::vec2f capInsets(
    ...
    //////////////////////////////////////////////////////////////////////////
    const mt::vec2f & ShapeThreePatchHorizontal::getCapInsets() const
    {
        return m_capInsets;
    }
    //////////////////////////////////////////////////////////////////////////
    mt::vec2f ShapeThreePatchHorizontal::getMinimumSize() const
    {
        return mt::vec2f( m_capInsets.x + m_capInsets.y, 0.f );
    }
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::updateVerticesLocal() const
    {
        const mt::vec2f & sourceSize = m_surface->getSize();

        float left = m_capInsets.x;
        float right = m_capInsets.y;

        float insets = left + right;

        if( insets > sourceSize.x && insets > 0.f )
        {
            float scale = sourceSize.x / insets;
    ...
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::updateVerticesWM() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::updateVerticesColor() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::render( const RenderPipelineInterfacePtr & _renderPipeline, const RenderContext * _context ) const
    {
        ...
        _renderPipeline->addRenderObject( _context, material, programVariable, vertices, 8, Detail::SHAPE_THREE_PATCH_HORIZONTAL_INDICES, 18, bb, EROF_NONE, MENGINE_DOCUMENT_FORWARD );
    }
    //////////////////////////////////////////////////////////////////////////
    void ShapeThreePatchHorizontal::_updateBoundingBox( mt::box2f * const _boundingBox, mt::box2f ** const _boundingBoxCurrent ) const
    {
        const RenderVertex2D * vertices = this->getVerticesWM();
