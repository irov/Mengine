...
{
    //////////////////////////////////////////////////////////////////////////
    class ShapeThreePatchVertical
        : public Shape
    {
        DECLARE_FACTORABLE( ShapeThreePatchVertical );
        DECLARE_VISITABLE( Node );

    public:
        ShapeThreePatchVertical();
        ~ShapeThreePatchVertical() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusiveNodePtr<ShapeThreePatchVertical> ShapeThreePatchVerticalPtr;
    //////////////////////////////////////////////////////////////////////////
    MENGINE_INLINE const RenderVertex2D * ShapeThreePatchVertical::getVerticesWM() const
    {
