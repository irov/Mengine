...
{
    //////////////////////////////////////////////////////////////////////////
    class SpriteSlice3Horizontal
        : public Node
        , protected BaseRender
        , protected BaseTransformation
    {
        DECLARE_FACTORABLE( SpriteSlice3Horizontal );
        DECLARE_VISITABLE( Node );
        DECLARE_RENDERABLE();
        DECLARE_TRANSFORMABLE();

    public:
        SpriteSlice3Horizontal();
        ~SpriteSlice3Horizontal() override;
    ...
    protected:
        ...
        void calcBandSizes( float * const _widths, float * const _height ) const;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusiveNodePtr<SpriteSlice3Horizontal> SpriteSlice3HorizontalPtr;
    //////////////////////////////////////////////////////////////////////////
    MENGINE_INLINE const RenderVertex2D * SpriteSlice3Horizontal::getVerticesWM() const
    {
