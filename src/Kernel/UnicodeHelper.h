...
namespace Mengine
{
    ...
    namespace Helper
    {
        ...
        bool unicodeToUtf8Size( const WChar * _unicode, size_t _unicodeSize, Char * _utf8, size_t _utf8Capacity, size_t * const _utf8Size = nullptr );
        bool unicodeToUtf8( const WString & _unicode, Char * const _utf8, size_t _utf8Capacity, size_t * const _utf8Size = nullptr );
        //////////////////////////////////////////////////////////////////////////
        bool utf8ToUnicode( const Char * _utf8, WChar * _unicode, size_t _unicodeCapacity, size_t * const _unicodeSize = nullptr );
        bool utf8ToUnicode( const Char * _utf8, WString * const _unicode );
        bool utf8ToUnicodeSize( const Char * _utf8, size_t _utf8Size, WChar * _unicode, size_t _unicodeCapacity, size_t * const _unicodeSize = nullptr );
        ...
        bool utf8ToUnicode( const ConstString & _utf8, WChar * _unicode, size_t _unicodeCapacity, size_t * const _unicodeSize = nullptr );
