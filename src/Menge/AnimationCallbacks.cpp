...
//////////////////////////////////////////////////////////////////////////
AnimationCallback::AnimationCallback(AnimationObject * _animObj, const std::string & _name, TUpdateCallback _updateCallback, TCompleteCallback _completeCallback, void * _userData)
: m_animObj(_animObj)
...
{
	if(m_animObj->m_calModel == model && m_updateCallback != NULL)
	{
...
{
	if(m_animObj->m_calModel == model && m_completeCallback != NULL)
	{
