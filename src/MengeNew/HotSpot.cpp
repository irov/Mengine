...
namespace	Menge
{
	...
	void HotSpot::onLeave()
	{
		if( m_onLeaveEvent )
		{
			this->callEvent( "LEAVE", "(O)", this->getEmbedding() );
		}
	}
	//////////////////////////////////////////////////////////////////////////
	void HotSpot::onEnter()
	{
		if( m_onEnterEvent )
		{
			this->callEvent( "ENTER", "(O)", this->getEmbedding() );
		}
	}
	//////////////////////////////////////////////////////////////////////////
	...
	void HotSpot::loader( XmlElement * _xml)
	{
		...
		{
			XML_CASE_ATTRIBUTE_NODE_METHOD( "Point", "Value", &HotSpot::addPoint );
		}
	}
	//////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////
	void HotSpot::_debugRender( const Viewport & _viewport )
	{
		...
		++it)
		{
			mt::vec2f beg = m_polygon[it];
			mt::vec2f end = m_polygon[ (it+1) % it_end ];

			beg += getWorldPosition();
			end += getWorldPosition();

			Holder<RenderEngine>::hostage()
				->renderLine( 0xFFFF0000, beg, end );
		}
	}
	//////////////////////////////////////////////////////////////////////////
