...
{
	//////////////////////////////////////////////////////////////////////////
	BodyListenerProxy::BodyListenerProxy( RigidBody2D* _body )
	: m_body( _body )
	{
	}
	//////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////
	void RigidBody2D::_debugRender( const Viewport & _viewport )
	{
		for( TShapeList::iterator it = m_shapeList.begin(),
			it_end = m_shapeList.end();
			it != it_end;
		it++ )
		{
			...
			for( mt::polygon::TVectorPoints::size_type i = 0; i < poly.num_points(); i++)
			{
				mt::vec2f beg = poly[i];
