...
namespace Metacode
{
    ...
    namespace Meta_Data
    {
        ...
        public:
            ...
            public:
                ...
                bool has_Sidecar_Path() const
                {
                    return (m_flagNoRequiredAttribute & EMETA_Sidecar_Path) != 0;
                }

                template<class C, class M>
                bool getm_Sidecar_Path( C _self, M _method ) const
                {
                    ...
                    (_self->*_method)( this->m_Sidecar_Path );
            ...
            protected:
                ...
                bool m_File_NoExist;
                Mengine::FilePath m_File_Path;
                Mengine::FilePath m_Sidecar_Path;
            };
            ...
            class Meta_ResourceTiledMap
                : public Meta_Resource
            {
            public:
                Meta_ResourceTiledMap();
    ...
    namespace Meta_TiledMap
    {
        ...
        public:
            ...
            template<class C, class M>
            void getm_HexSideLength( C _self, M _method ) const
            {
                (_self->*_method)( this->m_HexSideLength );
            }

            uint32_t get_HexSideLength() const
            {
                return this->m_HexSideLength;
            }
            ...
            uint32_t get_Orientation() const
            {
                return this->m_Orientation;
            }

            template<class C, class M>
            void getm_StaggerAxis( C _self, M _method ) const
            {
                (_self->*_method)( this->m_StaggerAxis );
            }

            uint32_t get_StaggerAxis() const
            {
                return this->m_StaggerAxis;
            }

            template<class C, class M>
            void getm_StaggerIndex( C _self, M _method ) const
            {
                (_self->*_method)( this->m_StaggerIndex );
            }

            uint32_t get_StaggerIndex() const
            {
                return this->m_StaggerIndex;
            }

            template<class C, class M>
            void getm_TileHeight( C _self, M _method ) const
            {
                (_self->*_method)( this->m_TileHeight );
            }

            uint32_t get_TileHeight() const
            {
                return this->m_TileHeight;
            }

            template<class C, class M>
            void getm_TileWidth( C _self, M _method ) const
            {
                (_self->*_method)( this->m_TileWidth );
            }

            uint32_t get_TileWidth() const
            {
        ...
        public:
            ...
            public:
                template<class C, class M>
                void getm_Id( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_Id );
                }
                ...
                const Mengine::String & get_Name() const
                {
                    return this->m_Name;
                }
                ...
                template<class C, class M>
                void getm_Visible( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_Visible );
                }
            ...
            public:
                ...
                public:
                    template<class C, class M>
                    void getm_Class( C _self, M _method ) const
                    {
                        (_self->*_method)( this->m_Class );
                    }

                    const Mengine::String & get_Class() const
                    {
                        return this->m_Class;
                    }

                    template<class C, class M>
                    void getm_Gid( C _self, M _method ) const
                    {
                        (_self->*_method)( this->m_Gid );
                    }
                    ...
                    const mt::vec2f & get_Position() const
                    {
                    ...
                    const Mengine::String & get_Type() const
                    {
                        return this->m_Type;
                    }
                ...
                public:
                    ...
                    public:
                        ...
                        const Mengine::String & get_Value() const
                        {
                            return this->m_Value;
                        }
                    ...
                    protected:
                        ...
                        uint32_t m_Type;
                        Mengine::String m_Value;
                    };

                protected:
                    Mengine::String m_Class;
                    uint32_t m_Gid;
                    uint32_t m_Id;
                    Mengine::String m_Name;
                    mt::vec2f m_Position;
                    ...
                    uint32_t m_Shape;
                    mt::vec2f m_Size;
                    Mengine::String m_Type;
                    bool m_Visible;
                public:
                    typedef Metabuf::Vector<Meta_Point> VectorMeta_Point;

                    const VectorMeta_Point & get_Includes_Point() const
                    {
                        return this->includes_Meta_Point;
                    }

                protected:
                    VectorMeta_Point includes_Meta_Point;
                public:
                    typedef Metabuf::Vector<Meta_Property> VectorMeta_Property;

                    const VectorMeta_Property & get_Includes_Property() const
                    {
                        return this->includes_Meta_Property;
                    }

                protected:
                    VectorMeta_Property includes_Meta_Property;
                };
            ...
            protected:
                ...
                bool m_Visible;
            public:
                typedef Metabuf::Vector<Meta_Object> VectorMeta_Object;

                const VectorMeta_Object & get_Includes_Object() const
                {
                    return this->includes_Meta_Object;
                }

            protected:
                VectorMeta_Object includes_Meta_Object;
            public:
                typedef Metabuf::Vector<Meta_Property> VectorMeta_Property;
            ...
            protected:
                VectorMeta_Property includes_Meta_Property;
            public:
                typedef Metabuf::Vector<Meta_Tile> VectorMeta_Tile;

                const VectorMeta_Tile & get_Includes_Tile() const
                {
                    return this->includes_Meta_Tile;
                }

            protected:
                VectorMeta_Tile includes_Meta_Tile;
            };
            ...
            public:
                template<class C, class M>
                void getm_Columns( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_Columns );
                }
                ...
                template<class C, class M>
                void getm_FirstGid( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_FirstGid );
                }

                uint32_t get_FirstGid() const
                {
                    return this->m_FirstGid;
                }

                template<class C, class M>
                void getm_ImageHeight( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_ImageHeight );
                }

                uint32_t get_ImageHeight() const
                {
                    return this->m_ImageHeight;
                }

                template<class C, class M>
                void getm_ImageWidth( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_ImageWidth );
                }

                uint32_t get_ImageWidth() const
                {
                    return this->m_ImageWidth;
                }

                template<class C, class M>
                void getm_Margin( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_Margin );
                }
                ...
                const Mengine::String & get_Resource() const
                {
                    return this->m_Resource;
                }

                template<class C, class M>
                void getm_Spacing( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_Spacing );
                }
                ...
                template<class C, class M>
                void getm_TileCount( C _self, M _method ) const
                {
                    (_self->*_method)( this->m_TileCount );
                }

                uint32_t get_TileCount() const
                {
            ...
            public:
                ...
                public:
                    ...
                    template<class C, class M>
                    void getm_LocalId( C _self, M _method ) const
                    {
                        (_self->*_method)( this->m_LocalId );
                    }

                    uint32_t get_LocalId() const
                    {
        ...
        protected:
            ...
            uint32_t m_Width;
        public:
            typedef Metabuf::Vector<Meta_ObjectLayer> VectorMeta_ObjectLayer;

            const VectorMeta_ObjectLayer & get_Includes_ObjectLayer() const
            {
                return this->includes_Meta_ObjectLayer;
            }

        protected:
            VectorMeta_ObjectLayer includes_Meta_ObjectLayer;
        public:
            typedef Metabuf::Vector<Meta_Property> VectorMeta_Property;
        ...
        protected:
            VectorMeta_Property includes_Meta_Property;
        public:
            typedef Metabuf::Vector<Meta_TileLayer> VectorMeta_TileLayer;

            const VectorMeta_TileLayer & get_Includes_TileLayer() const
            {
                return this->includes_Meta_TileLayer;
            }

        protected:
            VectorMeta_TileLayer includes_Meta_TileLayer;
        public:
            typedef Metabuf::Vector<Meta_Tileset> VectorMeta_Tileset;

            const VectorMeta_Tileset & get_Includes_Tileset() const
            {
                return this->includes_Meta_Tileset;
            }

        protected:
            VectorMeta_Tileset includes_Meta_Tileset;
        };
