...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    void AndroidInput::finalize()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    void AndroidInput::calcCursorPosition_( SDL_Window * _sdlWindow, Sint32 _mx, Sint32 _my, mt::vec2f * const _point ) const
    {
        int win_width;
        int win_height;
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode AndroidInput::acquireFingerIndex_( SDL_FingerID _fingerId )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode AndroidInput::releaseFingerIndex_( SDL_FingerID _fingerId )
    {
        for( uint32_t index = 0; index != MENGINE_INPUT_MAX_TOUCH; ++index )
        {
            SDL_FingerID fingerId = m_fingers[index];
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode AndroidInput::getFingerIndex_( SDL_FingerID _fingerId ) const
    {
        for( uint32_t index = 0; index != MENGINE_INPUT_MAX_TOUCH; ++index )
        {
            SDL_FingerID fingerId = m_fingers[index];
    ...
    //////////////////////////////////////////////////////////////////////////
    void AndroidInput::handleEvent( SDL_Window * _sdlWindow, const SDL_Event & _event )
    {
        switch( _event.type )
        {
        case SDL_MOUSEWHEEL:
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AndroidInput::isKeyDown( EKeyCode _code ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AndroidInput::isAnyKeyDown() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void AndroidInput::getCursorPosition( SDL_Window * _sdlWindow, mt::vec2f * const _point ) const
    {
        int x = 0;
        int y = 0;
        Uint32 state = SDL_GetMouseState( &x, &y );
    ...
    //////////////////////////////////////////////////////////////////////////
    EKeyCode AndroidInput::getKeyCode_( SDL_Scancode _key ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    SDL_Scancode AndroidInput::getSDLKey_( EKeyCode _code ) const
    {
