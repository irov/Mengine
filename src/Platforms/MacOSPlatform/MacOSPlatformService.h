...
namespace Mengine
{
    class MacOSPlatformService
        ...
        , public MacOSPlatformServiceExtensionInterface
    {
        DECLARE_UNKNOWABLE();

    public:
        MacOSPlatformService();
        ~MacOSPlatformService() override;
    ...
    public:
        ...
        size_t getTemporaryPath( Char * const _temporaryPath ) const override;
    ...
    public:
        void handleWindowDidResize() override;
        void handleWindowDidBecomeKey() override;
        void handleWindowDidResignKey() override;
        void handleWindowDidMiniaturize() override;
        void handleWindowDidDeminiaturize() override;
        void handleWindowWillClose() override;
    ...
    protected:
        bool writeUserDirectoryFile_( const Char * _basePath, const Char * _directoryPath, const Char * _filePath, const void * _data, size_t _size ) const;
