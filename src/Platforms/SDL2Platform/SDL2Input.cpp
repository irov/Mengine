...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL2Input::finalize()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    void SDL2Input::calcCursorPosition_( SDL_Window * _sdlWindow, Sint32 _mx, Sint32 _my, mt::vec2f * const _point ) const
    {
        int win_width;
        int win_height;
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode SDL2Input::acquireFingerIndex_( SDL_FingerID _fingerId )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode SDL2Input::releaseFingerIndex_( SDL_FingerID _fingerId )
    {
        for( uint32_t index = 0; index != MENGINE_INPUT_MAX_TOUCH; ++index )
        {
            SDL_FingerID fingerId = m_fingers[index];
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode SDL2Input::getFingerIndex_( SDL_FingerID _fingerId ) const
    {
        for( uint32_t index = 0; index != MENGINE_INPUT_MAX_TOUCH; ++index )
        {
            SDL_FingerID fingerId = m_fingers[index];
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL2Input::handleEvent( SDL_Window * _sdlWindow, const SDL_Event & _event )
    {
        switch( _event.type )
        {
        case SDL_MOUSEWHEEL:
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL2Input::isKeyDown( EKeyCode _code ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL2Input::isAnyKeyDown() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL2Input::getCursorPosition( SDL_Window * _sdlWindow, mt::vec2f * const _point ) const
    {
        int x = 0;
        int y = 0;
        Uint32 state = SDL_GetMouseState( &x, &y );
    ...
    //////////////////////////////////////////////////////////////////////////
    EKeyCode SDL2Input::getKeyCode_( SDL_Scancode _key ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    SDL_Scancode SDL2Input::getSDLKey_( EKeyCode _code ) const
    {
