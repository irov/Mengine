...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL3Input::finalize()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    void SDL3Input::calcCursorPosition_( SDL_Window * _sdlWindow, float _mx, float _my, mt::vec2f * const _point ) const
    {
        int win_width;
        int win_height;
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode SDL3Input::acquireFingerIndex_( SDL_FingerID _fingerId )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode SDL3Input::releaseFingerIndex_( SDL_FingerID _fingerId )
    {
        for( uint32_t index = 0; index != MENGINE_INPUT_MAX_TOUCH; ++index )
        {
            SDL_FingerID fingerId = m_fingers[index];
            ...
            {
                m_fingers[index] = (SDL_FingerID)-1;
    ...
    //////////////////////////////////////////////////////////////////////////
    ETouchCode SDL3Input::getFingerIndex_( SDL_FingerID _fingerId ) const
    {
        for( uint32_t index = 0; index != MENGINE_INPUT_MAX_TOUCH; ++index )
        {
            SDL_FingerID fingerId = m_fingers[index];
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL3Input::handleEvent( SDL_Window * _sdlWindow, const SDL_Event & _event )
    {
        switch( _event.type )
        {
        ...
        case SDL_EVENT_FINGER_UP:
            {
                ...
                if( fingerIndex == TC_TOUCH_INVALID )
                {
                    LOGGER_INFO( "platform", "SDL_EVENT_FINGER_UP unknown touch" );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL3Input::isKeyDown( EKeyCode _code ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL3Input::isAnyKeyDown() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL3Input::getCursorPosition( SDL_Window * _sdlWindow, mt::vec2f * const _point ) const
    {
        float x = 0.f;
        float y = 0.f;
        SDL_MouseButtonFlags state = SDL_GetMouseState( &x, &y );
    ...
    //////////////////////////////////////////////////////////////////////////
    EKeyCode SDL3Input::getKeyCode_( SDL_Scancode _key ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    SDL_Scancode SDL3Input::getSDLKey_( EKeyCode _code ) const
    {
