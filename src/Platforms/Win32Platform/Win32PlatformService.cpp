...
namespace Mengine
{
    ...
    bool Win32PlatformService::_runService()
    {
        ...
        auto support_message = []( const Char * isa_feature, bool is_supported )
        {
            ...
            LOGGER_VERBOSE_LEVEL( STRINGIZE_STRING_LOCAL( "platform" ), LM_INFO, LFILTER_NONE, color, nullptr, 0, LFLAG_SHORT )("%s: %s"
                , isa_feature
                , is_supported == true ? "+" : "-"
                );
        };
    ...
    //////////////////////////////////////////////////////////////////////////
    bool Win32PlatformService::createProcessDump( const Char * _dumpPath, void * const _pExceptionPointers, bool _full )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool Win32PlatformService::tickPlatform( float _frameTime )
    {
#if defined(MENGINE_WINDOWS_SUPPORT_MIN_VERSION_VISTA)
...
#   error "Platform not supported!"
    ...
    //////////////////////////////////////////////////////////////////////////
    bool Win32PlatformService::getCallstack( ThreadId _threadId, Char * const _stack, size_t _capacity, PCONTEXT _context ) const
    {
        HANDLE hProcess = ::GetCurrentProcess();
