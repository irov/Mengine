...
namespace Menge
{
    ...
    //////////////////////////////////////////////////////////////////////////
    void PybindSource::addFunction( const pybind::object & _obj, const pybind::args & _args )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void PybindSource::addCallback( const pybind::object & _obj, const pybind::args & _args )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void PybindSource::addScope( const pybind::object & _obj, const pybind::args & _args )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    pybind::tuple PybindSource::addIf( const pybind::object & _obj, const pybind::args & _args )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    pybind::tuple PybindSource::addSwitch( size_t _count, const pybind::object & _obj, const pybind::args & _args )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    GOAP::SourcePtr PybindSource::addRepeat( const pybind::object & _obj, const pybind::args & _args )
    {
        GOAP::ScopeProviderPtr provider = GOAP_NEW PybindScopeProvider( _obj, _args );
    ...
    //////////////////////////////////////////////////////////////////////////
    GOAP::SourcePtr PybindSource::addGuard( const pybind::object & _begin, const pybind::object & _end, const pybind::args & _args )
    {
