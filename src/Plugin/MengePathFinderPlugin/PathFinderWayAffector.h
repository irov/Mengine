...
namespace Menge
{
	...
	public:
		bool initialize( Node * _node, const pybind::list & _satellite, float _offset, float _speed, const pybind::list & _way, bool _preparePosition, const pybind::object & _cb, const pybind::detail::args_operator_t & _args );
