...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AV1VideoDecoder::_initialize()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AV1VideoDecoder::_prepareData()
    {
        bool stateFlag = true;
    ...
    //////////////////////////////////////////////////////////////////////////
    void AV1VideoDecoder::_finalize()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    size_t AV1VideoDecoder::_decode( void * const _buffer, size_t _bufferSize )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AV1VideoDecoder::decodeBuffer_( const yuv_buffer & _yuvBuffer, uint8_t * const _buffer, size_t _size )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    size_t AV1VideoDecoder::read_buffer_data_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    EVideoDecoderReadState AV1VideoDecoder::readNextFrame( float _request, float * const _pts )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AV1VideoDecoder::seekToFrame( float _time )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AV1VideoDecoder::_seek( float _time )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    float AV1VideoDecoder::_tell() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void AV1VideoDecoder::setPitch( size_t _pitch )
    {
        m_pitch = (uint32_t)_pitch;
    }
    //////////////////////////////////////////////////////////////////////////
    size_t AV1VideoDecoder::getPitch() const
    {
