...
namespace Mengine
{
    ...
    {
        ADMOB_INITIALIZE,
        ADMOB_INTERSTITIALAD_LOADED,
        ADMOB_INTERSTITIALAD_FAILED_TO_LOAD,
        ADMOB_INTERSTITIALAD_OPENED,
        ADMOB_INTERSTITIALAD_FAILED_TO_OPENED,
        ADMOB_INTERSTITIALAD_LEFT_APPLICATION,
        ADMOB_INTERSTITIALAD_CLOSED,
        ADMOB_REWARDEDVIDEOAD_LOADED,
        ADMOB_REWARDEDVIDEOAD_OPENED,
        ADMOB_REWARDEDVIDEOAD_FAILED_TO_OPENED,
        ...
        ADMOB_REWARDEDVIDEOAD_FAILED_TO_LOAD,
    ...
    public:
        ...
        virtual void onAdMobInterstitialAdFailedToOpened() = 0;
    ...
    public:
        ...
        virtual void onAdMobRewardedVideoAdFailedToOpened() = 0;
