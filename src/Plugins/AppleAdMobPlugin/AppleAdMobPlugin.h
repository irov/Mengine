...
@interface AppleAdMobPlugin : NSObject<iOSPluginInterface, AppleAdMobInterface, AppleAdvertisementProviderInterface, iOSPluginAppTrackingTransparencyDelegateInterface>
