...
@implementation AppleAppLovinPlugin
...
+ (instancetype)sharedInstance {
    static AppleAppLovinPlugin * sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [iOSDetail getPluginDelegateOfClass:[AppleAppLovinPlugin class]];
    });
