#import "AppleUserNotificationCenterPlugin.h"
...
@implementation AppleUserNotificationCenterPlugin

+ (instancetype)sharedInstance {
    static AppleUserNotificationCenterPlugin *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [iOSDetail getPluginDelegateOfClass:[AppleUserNotificationCenterPlugin class]];
    });
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    __weak AppleUserNotificationCenterPlugin * weakSelf = self;
    
    [iOSDetail addDidBecomeActiveOperationWithCompletion:^(void (^ _Nonnull completion)(void)) {
        AppleUserNotificationCenterPlugin * strongSelf = weakSelf;
