...
namespace Mengine
{
    ...
    bool AreaOfInterestPlugin::_initializePlugin()
    {
        ...
        {
            ADD_SCRIPT_EMBEDDING( STRINGIZE_STRING_LOCAL( "AreaOfInterestScriptEmbedding" ), Helper::makeFactorableUnique<AreaOfInterestScriptEmbedding>( MENGINE_DOCUMENT_FACTORABLE ) );
