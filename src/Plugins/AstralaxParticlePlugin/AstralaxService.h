...
namespace Mengine
{
    ...
    public:
        AstralaxEmitterContainerInterfacePtr createEmitterContainerFromFile( const FileGroupInterfacePtr & _fileGroupName, const FilePath & _filePath, const DocumentPtr & _doc ) override;
