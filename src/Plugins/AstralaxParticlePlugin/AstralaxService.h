...
namespace Mengine
{
    ...
    public:
        AstralaxEmitterContainerInterfacePtr createEmitterContainerFromFile( const FileGroupInterfacePtr & _fileGroupName, const FilePath & _filePath, const Char * _doc ) override;
