...
namespace Mengine
{
    ...
    {
        pybind::enum_<EFigmaActionInputKind>( _kernel, "FigmaActionInputKind" )
            .def( "FIGMA_ACTION_INPUT_POINTER", EFigmaActionInputKind::Pointer )
            .def( "FIGMA_ACTION_INPUT_KEY", EFigmaActionInputKind::Key )
            .def( "FIGMA_ACTION_INPUT_TIMER", EFigmaActionInputKind::Timer )
            .def( "FIGMA_ACTION_INPUT_PROGRAMMATIC", EFigmaActionInputKind::Programmatic )
            ;

        pybind::enum_<EFigmaTriggerType>( _kernel, "FigmaTriggerType" )
            .def( "FIGMA_TRIGGER_CLICK", EFigmaTriggerType::Click )
            .def( "FIGMA_TRIGGER_HOVER_ENTER", EFigmaTriggerType::HoverEnter )
            .def( "FIGMA_TRIGGER_HOVER_LEAVE", EFigmaTriggerType::HoverLeave )
            .def( "FIGMA_TRIGGER_PRESS", EFigmaTriggerType::Press )
            .def( "FIGMA_TRIGGER_POINTER_DOWN", EFigmaTriggerType::PointerDown )
            .def( "FIGMA_TRIGGER_POINTER_UP", EFigmaTriggerType::PointerUp )
            .def( "FIGMA_TRIGGER_AFTER_TIMEOUT", EFigmaTriggerType::AfterTimeout )
            .def( "FIGMA_TRIGGER_KEY_DOWN", EFigmaTriggerType::KeyDown )
            ;

        pybind::enum_<EFigmaActionResult>( _kernel, "FigmaActionResult" )
            .def( "FIGMA_ACTION_RESULT_ALLOW_DEFAULT", EFigmaActionResult::AllowDefault )
            .def( "FIGMA_ACTION_RESULT_CONSUME", EFigmaActionResult::Consume )
            .def( "FIGMA_ACTION_RESULT_NAVIGATE_FRAME", EFigmaActionResult::NavigateFrame )
            .def( "FIGMA_ACTION_RESULT_OPEN_OVERLAY", EFigmaActionResult::OpenOverlay )
            .def( "FIGMA_ACTION_RESULT_CLOSE_OVERLAY", EFigmaActionResult::CloseOverlay )
            ;

        pybind::enum_<EFigmaConnectionType>( _kernel, "FigmaConnectionType" )
            .def( "FIGMA_CONNECTION_NONE", EFigmaConnectionType::None )
            .def( "FIGMA_CONNECTION_INTERNAL_NODE", EFigmaConnectionType::InternalNode )
            .def( "FIGMA_CONNECTION_BACK", EFigmaConnectionType::Back )
            .def( "FIGMA_CONNECTION_CLOSE", EFigmaConnectionType::Close )
            ;

        pybind::enum_<EFigmaNavigationType>( _kernel, "FigmaNavigationType" )
            .def( "FIGMA_NAVIGATION_NAVIGATE", EFigmaNavigationType::Navigate )
            .def( "FIGMA_NAVIGATION_OVERLAY", EFigmaNavigationType::Overlay )
            .def( "FIGMA_NAVIGATION_SWAP", EFigmaNavigationType::Swap )
            .def( "FIGMA_NAVIGATION_SCROLL_TO", EFigmaNavigationType::ScrollTo )
            ;
