...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    TaskLocalDelay::TaskLocalDelay( float _time, const DocumentPtr & _doc )
        : m_time( _time )
        , m_doc( _doc )
        , m_id( 0 )
    {
    ...
    {
        SchedulerEventInterfacePtr ev = Helper::makeFactorableUnique<TaskLocalDelay::ScheduleEvent>( m_doc, this, _node );
