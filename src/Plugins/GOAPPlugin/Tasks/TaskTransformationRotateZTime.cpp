...
{
    //////////////////////////////////////////////////////////////////////////
    TaskTransformationRotateZTime::TaskTransformationRotateZTime( const TransformationPtr & _transformation, const AffectorablePtr & _affectorable, const EasingInterfacePtr & _easing, float _to, float _time, ETransformationRotateMode _mode, const DocumentPtr & _doc )
    ...
    bool TaskTransformationRotateZTime::_onRun( GOAP::NodeInterface * _node )
    {
        ...
        AffectorPtr affector = Helper::makeFactorableUnique<AffectorTransformationRotateTime>( m_doc, _node, transformCb, orientationZ, m_to, m_time, m_mode );
