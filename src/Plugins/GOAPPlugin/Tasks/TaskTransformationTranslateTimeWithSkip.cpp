...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    TaskTransformationTranslateTimeWithSkip::TaskTransformationTranslateTimeWithSkip( const TransformationPtr & _transformation, const AffectorablePtr & _affectorable, const EasingInterfacePtr & _easing, const mt::vec3f & _to, float _time, const DocumentPtr & _doc )
        : m_transformation( _transformation )
    ...
    bool TaskTransformationTranslateTimeWithSkip::_onRun( GOAP::NodeInterface * _node )
    {
        ...
        AffectorPtr affector = Helper::makeFactorableUnique<Detail::TaskTransformationTranslateTimeWithSkipAffector>( m_doc, _node, m_transformation, position, m_to, m_time );
