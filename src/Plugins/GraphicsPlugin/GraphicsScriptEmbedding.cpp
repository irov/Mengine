...
namespace Mengine
{
    ...
    bool GraphicsScriptEmbedding::embed( pybind::kernel_interface * _kernel )
    {
        ...
        pybind::interface_<Graphics, pybind::bases<Node>>( _kernel, "Graphics", false )
            .def( "setResourceImage", &Graphics::setResourceImage )
            .def( "getResourceImage", &Graphics::getResourceImage )
            .def( "setUVRect", &Graphics::setUVRect )
            .def( "getUVRect", &Graphics::getUVRect )
            .def( "setLineWidth", &Graphics::setLineWidth )
            .def( "getLineWidth", &Graphics::getLineWidth )
            .def( "setOutlineWidth", &Graphics::setOutlineWidth )
            .def( "getOutlineWidth", &Graphics::getOutlineWidth )
            .def( "setOutlineColor", &Graphics::setOutlineColor )
            .def( "getOutlineColor", &Graphics::getOutlineColor )
            ...
            .def( "setLineDash", &Graphics::setLineDash )
            .def( "clearLineDash", &Graphics::clearLineDash )
            .def( "setPathTrim", &Graphics::setPathTrim )
            .def( "setPathMarkers", &Graphics::setPathMarkers )
            .def( "setStrokeAlignment", &Graphics::setStrokeAlignment )
            .def( "getStrokeAlignment", &Graphics::getStrokeAlignment )
            .def( "setUVMode", &Graphics::setUVMode )
            .def( "getUVMode", &Graphics::getUVMode )
            ...
            .def( "setRectQuality", &Graphics::setRectQuality )
            .def( "getRectQuality", &Graphics::getRectQuality )
            .def( "pushState", &Graphics::pushState )
            .def( "popState", &Graphics::popState )
            .def( "beginFill", &Graphics::beginFill )
            .def( "endFill", &Graphics::endFill )
            .def( "createPath", &Graphics::createPath )
            .def( "drawPath", &Graphics::drawPath )
            ...
            .def( "drawRoundedPolyline", &Graphics::drawRoundedPolyline )
            .def( "drawPolygonOffset", &Graphics::drawPolygonOffset )
            ...
            .def( "drawRoundedRing", &Graphics::drawRoundedRing )
            .def( "drawCapsule", &Graphics::drawCapsule )
            .def( "drawRegularPolygon", &Graphics::drawRegularPolygon )
            .def( "drawStar", &Graphics::drawStar )
            .def( "drawSuperellipse", &Graphics::drawSuperellipse )
