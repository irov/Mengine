...
namespace Mengine
{
    ...
    bool ImGUIPlugin::_initializePlugin()
    {
        ...
        NOTIFICATION_ADDOBSERVERMETHOD( NOTIFICATOR_CREATE_RENDER_WINDOW, this, &ImGUIPlugin::notifyCreateRenderWindow_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD( NOTIFICATOR_RENDER_DEVICE_LOST_PREPARE, this, &ImGUIPlugin::notifyRenderDeviceLostPrepare_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD( NOTIFICATOR_RENDER_DEVICE_LOST_RESTORE, this, &ImGUIPlugin::notifyRenderDeviceLostRestore_, MENGINE_DOCUMENT_FACTORABLE );
