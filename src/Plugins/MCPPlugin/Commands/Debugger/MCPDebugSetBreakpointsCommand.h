...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    class MCPDebugSetBreakpointsCommand
        : public MCPCommandInterface
        , public Factorable
    {
    public:
        explicit MCPDebugSetBreakpointsCommand( MCPDebuggerContext * _context );
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<MCPDebugSetBreakpointsCommand, MCPCommandInterface> MCPDebugSetBreakpointsCommandPtr;
    //////////////////////////////////////////////////////////////////////////
}
