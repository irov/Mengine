#include "MCPAccelerometerInputSequenceStep.h"

namespace Mengine
{
    //////////////////////////////////////////////////////////////////////////
    MCPAccelerometerInputSequenceStep::MCPAccelerometerInputSequenceStep( const MCPCommandInterfacePtr & _command )
        : m_command( _command )
    {
    }
    //////////////////////////////////////////////////////////////////////////
    bool MCPAccelerometerInputSequenceStep::execute( const MCPInputSequenceStepRequest & _request, MCPInputSequenceStepResponse * const _response )
    {
        jpp::object params;
