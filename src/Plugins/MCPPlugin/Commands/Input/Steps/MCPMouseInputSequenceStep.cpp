#include "MCPMouseInputSequenceStep.h"

namespace Mengine
{
    //////////////////////////////////////////////////////////////////////////
    MCPMouseInputSequenceStep::MCPMouseInputSequenceStep( const MCPCommandInterfacePtr & _command )
        : m_command( _command )
    {
    }
    //////////////////////////////////////////////////////////////////////////
    bool MCPMouseInputSequenceStep::execute( const MCPInputSequenceStepRequest & _request, MCPInputSequenceStepResponse * const _response )
    {
        jpp::object params;
