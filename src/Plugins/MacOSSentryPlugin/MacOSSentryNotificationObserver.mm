...
{
    //////////////////////////////////////////////////////////////////////////
    MacOSSentryNotificationObserver::MacOSSentryNotificationObserver()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    MacOSSentryNotificationObserver::~MacOSSentryNotificationObserver()
    ...
    //////////////////////////////////////////////////////////////////////////
    bool MacOSSentryNotificationObserver::initialize()
    {
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_BOOTSTRAPPER_CREATE_APPLICATION, &MacOSSentryNotificationObserver::notifyCreateApplication_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_ASSERTION, &MacOSSentryNotificationObserver::notifyAssertion_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_ERROR, &MacOSSentryNotificationObserver::notifyError_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_ENGINE_STOP, &MacOSSentryNotificationObserver::notifyEngineStop_, MENGINE_DOCUMENT_FACTORABLE );

        return true;
    }
    //////////////////////////////////////////////////////////////////////////
    void MacOSSentryNotificationObserver::finalize()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void MacOSSentryNotificationObserver::setupApplicationScope()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void MacOSSentryNotificationObserver::notifyAssertion_( const Char * _category, EAssertionLevel _level, const Char * _test, const Char * _file, int32_t _line, const Char * _message )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void MacOSSentryNotificationObserver::notifyError_( const Char * _category, EErrorLevel _level, const Char * _file, int32_t _line, const Char * _message )
    {
        MENGINE_UNUSED( _category );
    ...
    //////////////////////////////////////////////////////////////////////////
    void MacOSSentryNotificationObserver::notifyEngineStop_()
    {
        [SentrySDK configureScope:^(SentryScope * _Nonnull scope) {
