...
namespace Mengine
{
    ...
    namespace Detail
    {
        ...
        static PyObject * Movie2_setEventListener( pybind::kernel_interface * _kernel, Movie2 * _node, PyObject * _args, PyObject * _kwds )
        {
            ...
            Helper::registerAnimatableEventReceiver<PythonMovie2EventReceiver>( _kernel, py_kwds, _node, MENGINE_DOCUMENT_PYTHON );
        ...
        static PyObject * Movie2SubComposition_setEventListener( pybind::kernel_interface * _kernel, Movie2SubComposition * _node, PyObject * _args, PyObject * _kwds )
        {
            ...
            pybind::dict py_kwds( _kernel, _kwds );
            Helper::registerAnimatableEventReceiver<PythonMovie2SubCompositionEventReceiver>( _kernel, py_kwds, _node, MENGINE_DOCUMENT_PYTHON );
    ...
    bool Movie2ScriptEmbedding::embed( pybind::kernel_interface * _kernel )
    {
        pybind::interface_<Movie2, pybind::bases<Node>>( _kernel, "Movie2", false )
            ...
            .def( "setExtraTransformation", &Movie2::setExtraTransformation )
            .def( "removeExtraTransformation", &Movie2::removeExtraTransformation )
            ;
