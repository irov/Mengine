...
namespace Mengine
{
    ...
    {
        VOCABULARY_SET( Factory, STRINGIZE_STRING_LOCAL( "FileGroupFactory" ), STRINGIZE_STRING_LOCAL( "global" ), Helper::makeFactory<Win32FileGroupDirectoryFactory>( FilePath::none() ) );
        ...
        VOCABULARY_SET( Factory, STRINGIZE_STRING_LOCAL( "FileGroupFactory" ), STRINGIZE_STRING_LOCAL( "dir" ), Helper::makeFactory<Win32FileGroupDirectoryFactory>( relationPath ) );
