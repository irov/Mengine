...
namespace Mengine
{    
    class cURLHttpErrorHelper
    {
    public:
        cURLHttpErrorHelper( const Char * _file, uint32_t _line, const Char * _method );
...
#define MENGINE_CURLERRORCHECK( Method, HRES )\
    (Mengine::cURLHttpErrorHelper(MENGINE_CODE_FILE, MENGINE_CODE_LINE, Method ) == HRES)
//////////////////////////////////////////////////////////////////////////
