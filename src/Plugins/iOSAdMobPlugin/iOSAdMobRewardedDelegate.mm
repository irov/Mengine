...
- (BOOL) show:(NSString * _Nonnull)placement {
    ...
    [self.m_rewardedAd presentFromRootViewController:viewController
        ...
        if (callback != nil) {
            ...
            [callback oniOSAdvertisementUserRewarded:placement withLabel:label withAmount:amount];
        }
    }];
...
- (void) loadAd {
    ...
    [GADRewardedAd loadWithAdUnitID:self.m_adUnitId
        ...
        __weak iOSAdMobRewardedDelegate * weakSelf2 = strongSelf;
        rewardedAd.paidEventHandler = ^(GADAdValue * _Nonnull adValue) {
            iOSAdMobRewardedDelegate * strongSelf2 = weakSelf2;
...
- (void)adWillDismissFullScreenContent:(id<GADFullScreenPresentingAd>)ad {
    ...
    [self eventRewarded:@"will_dismiss" params:@{}];
}
