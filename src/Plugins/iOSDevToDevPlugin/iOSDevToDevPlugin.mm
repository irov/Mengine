...
@implementation iOSDevToDevPlugin
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    if ([AppleBundle hasPluginConfig:@"MengineiOSDevToDevPlugin"] == NO) {
        return NO;
    }

    NSString * MengineiOSDevToDevPlugin_AppKey = [AppleBundle getPluginConfigString:@"MengineiOSDevToDevPlugin" withKey:@"AppKey" withDefault:nil];
    ...
    [DTDAnalytics applicationKey:MengineiOSDevToDevPlugin_AppKey configuration:config];
