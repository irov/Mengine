...
@implementation iOSFirebaseAnalyticsPlugin

+ (instancetype)sharedInstance {
    static iOSFirebaseAnalyticsPlugin *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [iOSDetail getPluginDelegateOfClass:[iOSFirebaseAnalyticsPlugin class]];
    });
