#import "iOSFirebaseCrashlyticsPlugin.h"
...
#import "iOSFirebaseCrashlyticsANRMonitor.h"

#import <FirebaseCrashlytics/FirebaseCrashlytics.h>

#define PLUGIN_BUNDLE_NAME "MengineiOSFirebaseAnalyticsPlugin"

@implementation iOSFirebaseCrashlyticsPlugin

+ (instancetype)sharedInstance {
    static iOSFirebaseCrashlyticsPlugin *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [iOSDetail getPluginDelegateOfClass:[iOSFirebaseCrashlyticsPlugin class]];
    });
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[iOSFirebaseCrashlyticsANRMonitor sharedInstance] runANRMainWatcher];
