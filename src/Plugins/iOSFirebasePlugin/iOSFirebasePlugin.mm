#import "iOSFirebasePlugin.h"

#import "Environment/iOS/iOSDetail.h"

#import <FirebaseCore/FirebaseCore.h>

@implementation iOSFirebasePlugin

+ (instancetype)sharedInstance {
    static iOSFirebasePlugin *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [iOSDetail getPluginDelegateOfClass:[iOSFirebasePlugin class]];
    });
