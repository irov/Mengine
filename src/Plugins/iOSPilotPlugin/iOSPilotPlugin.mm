...
#define PLUGIN_BUNDLE_NAME "MengineiOSPilotPlugin"
@interface iOSPilotPlugin () <PilotObjCSessionDelegate, PilotObjCActionDelegate, PilotObjCLoggerDelegate>
@end

@implementation iOSPilotPlugin

+ (instancetype)sharedInstance {
    static iOSPilotPlugin *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [iOSDetail getPluginDelegateOfClass:[iOSPilotPlugin class]];
    });
