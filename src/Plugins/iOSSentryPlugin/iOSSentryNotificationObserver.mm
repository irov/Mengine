...
{
    //////////////////////////////////////////////////////////////////////////
    iOSSentryNotificationObserver::iOSSentryNotificationObserver()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    iOSSentryNotificationObserver::~iOSSentryNotificationObserver()
    ...
    //////////////////////////////////////////////////////////////////////////
    bool iOSSentryNotificationObserver::initialize()
    {
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_BOOTSTRAPPER_CREATE_APPLICATION, &iOSSentryNotificationObserver::notifyCreateApplication_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_ASSERTION, &iOSSentryNotificationObserver::notifyAssertion_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_ERROR, &iOSSentryNotificationObserver::notifyError_, MENGINE_DOCUMENT_FACTORABLE );
        NOTIFICATION_ADDOBSERVERMETHOD_THIS( NOTIFICATOR_ENGINE_STOP, &iOSSentryNotificationObserver::notifyEngineStop_, MENGINE_DOCUMENT_FACTORABLE );

        return true;
    }
    //////////////////////////////////////////////////////////////////////////
    void iOSSentryNotificationObserver::finalize()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void iOSSentryNotificationObserver::setupApplicationScope()
    {
        this->notifyCreateApplication_();
    }
    //////////////////////////////////////////////////////////////////////////
    void iOSSentryNotificationObserver::notifyCreateApplication_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void iOSSentryNotificationObserver::notifyAssertion_( const Char * _category, EAssertionLevel _level, const Char * _test, const Char * _file, int32_t _line, const Char * _message )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void iOSSentryNotificationObserver::notifyError_( const Char * _category, EErrorLevel _level, const Char * _file, int32_t _line, const Char * _message )
    {
        MENGINE_UNUSED( _category );
    ...
    //////////////////////////////////////////////////////////////////////////
    void iOSSentryNotificationObserver::notifyEngineStop_()
    {
        [SentrySDK configureScope:^(SentryScope * _Nonnull scope) {
