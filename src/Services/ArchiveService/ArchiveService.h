...
namespace Mengine
{
    ...
    public:
        ...
        bool decompressStream( const ArchivatorInterfacePtr & _archivator, const InputStreamInterfacePtr & _stream, size_t _size, void * const _memory, size_t _capacity, size_t * const _uncompress ) override;
    ...
    public:
        ...
        bool decompressBuffer( const ArchivatorInterfacePtr & _archivator, const void * _buffer, size_t _size, void * const _memory, size_t _capacity, size_t * const _uncompress ) override;
    };
}
