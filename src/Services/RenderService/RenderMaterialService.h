...
namespace Mengine
{
    ...
    public:
        const RenderMaterialStage * createMaterialStage( const ConstString & _materialName, const RenderMaterialStage & _stage, const DocumentInterfacePtr & _doc ) override;
        const RenderMaterialStage * removeMaterialStage( const ConstString & _materialName ) override;
