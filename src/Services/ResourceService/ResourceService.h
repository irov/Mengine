...
namespace Mengine
{
    ...
    public:
        ResourcePointer createResource( const ResourceCook & _cook, const DocumentInterfacePtr & _doc ) override;
    ...
    public:
        ...
        const ResourcePtr & getResourceReference( const ResourceUID & _uid ) const override;
