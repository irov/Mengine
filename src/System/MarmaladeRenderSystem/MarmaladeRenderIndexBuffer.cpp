...
{
	//////////////////////////////////////////////////////////////////////////
	MarmaladeRenderIndexBuffer::MarmaladeRenderIndexBuffer()
	...
	//////////////////////////////////////////////////////////////////////////
	bool MarmaladeRenderIndexBuffer::initialize( ServiceProviderInterface * _serviceProvider, uint32_t _indexNum, bool _dynamic )
	{
	...
	//////////////////////////////////////////////////////////////////////////
	bool MarmaladeRenderIndexBuffer::unlock()
	{
	...
	//////////////////////////////////////////////////////////////////////////
	void MarmaladeRenderIndexBuffer::enable()
	{
		GLCALL( m_serviceProvider, glBindBuffer, (GL_ELEMENT_ARRAY_BUFFER, m_id) );
	}
}