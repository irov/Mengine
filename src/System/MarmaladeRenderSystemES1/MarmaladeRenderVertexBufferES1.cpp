...
{
	//////////////////////////////////////////////////////////////////////////
	MarmaladeRenderVertexBufferES1::MarmaladeRenderVertexBufferES1()
	...
	//////////////////////////////////////////////////////////////////////////
	bool MarmaladeRenderVertexBufferES1::initialize( ServiceProviderInterface * _serviceProvider, uint32_t _vertexNum, bool _dynamic )
	{ 
	...
	//////////////////////////////////////////////////////////////////////////
	RenderVertex2D * MarmaladeRenderVertexBufferES1::lock( uint32_t _offset, uint32_t _count, EBufferLockFlag _flags )
	{
	...
	//////////////////////////////////////////////////////////////////////////
	bool MarmaladeRenderVertexBufferES1::unlock()
	{
	...
	//////////////////////////////////////////////////////////////////////////
	void MarmaladeRenderVertexBufferES1::enable()
	{
		GLCALL( m_serviceProvider, glBindBuffer, (GL_ARRAY_BUFFER, m_id) );
	}
}
