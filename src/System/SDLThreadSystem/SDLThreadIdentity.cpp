...
namespace Menge
{
	...
	{
		SDLThreadIdentity * thread = static_cast<SDLThreadIdentity *>(_userData);
    ...
    //////////////////////////////////////////////////////////////////////////
	bool SDLThreadIdentity::initialize( ServiceProviderInterface * _serviceProvider, const ThreadMutexInterfacePtr & _mutex, int _priority )
    {
		m_serviceProvider = _serviceProvider;
		m_mutex = _mutex;

		SDL_Thread * thread = SDL_CreateThread( &s_tread_job, "Mengine Thread", (void *)this );
