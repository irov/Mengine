...
namespace Mengine
{
    class ALSASoundBufferBase
        : public SoundBufferInterface
    {
    public:
        ALSASoundBufferBase();
        ~ALSASoundBufferBase() override;
    ...
    public:
        ...
        virtual bool setLoopSource( bool _looped );
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<ALSASoundBufferBase, SoundBufferInterface> ALSASoundBufferBasePtr;
    //////////////////////////////////////////////////////////////////////////
}
