...
namespace Mengine
{
    namespace Detail
    {
        ...
        static void resamplePCM16Linear( const int16_t * _src, uint32_t _sourceFrames, uint32_t _channels, uint32_t _sourceFrequency, int16_t * _dst, uint32_t _targetFrames, uint32_t _targetFrequency )
        {
            ...
            for( uint32_t frame = 0; frame != _targetFrames; ++frame )
            {
                ...
                {
                    targetFrame[channel] = Helper::interpolateALSASoundPCM16Sample( frame0, frame1, _channels, channel, alpha );
                }
            }
        }
        //////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////
    ALSASoundBufferMemory::ALSASoundBufferMemory()
        : m_pcmDataSize( 0 )
    {
    }
    //////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundBufferMemory::_acquireSoundBuffer()
    {
        return true;
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundBufferMemory::_releaseSoundBuffer()
    {
        m_pcmMemory = nullptr;
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundBufferMemory::updateSoundBuffer()
    {
        return false;
    }
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundBufferMemory::load( const SoundDecoderInterfacePtr & _soundDecoder )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundBufferMemory::playSource( bool _looped, float _position )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundBufferMemory::stopSource()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundBufferMemory::pauseSource()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundBufferMemory::resumeSource()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundBufferMemory::setTimePosition( float _position )
    {
        MENGINE_UNUSED( _position );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundBufferMemory::getTimePosition( float * const _position ) const
    {
        *_position = 0.f;
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundBufferMemory::setVolume( float _gain )
    {
        MENGINE_UNUSED( _gain );
    }
    //////////////////////////////////////////////////////////////////////////
    const MemoryInterfacePtr & ALSASoundBufferMemory::getPCMMemory() const
    {
        return m_pcmMemory;
    }
    //////////////////////////////////////////////////////////////////////////
    uint32_t ALSASoundBufferMemory::getFrameCount() const
    {
        if( m_channels == 0 )
        {
            return 0;
    ...
    //////////////////////////////////////////////////////////////////////////
    uint32_t ALSASoundBufferMemory::renderMixerFrames( float * _mixBuffer, uint32_t _outputChannels, uint32_t _frameOffset, uint32_t _frames, float _gain, uint32_t _framePosition, bool _loop, uint32_t * const _outFramePosition )
    {
