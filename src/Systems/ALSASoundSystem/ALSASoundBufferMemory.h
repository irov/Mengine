...
namespace Mengine
{
    class ALSASoundBufferMemory
        : public ALSASoundBufferBase
    {
        DECLARE_FACTORABLE( ALSASoundBufferMemory );

    public:
        ALSASoundBufferMemory();
        ~ALSASoundBufferMemory() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<ALSASoundBufferMemory, SoundBufferInterface> ALSASoundBufferMemoryPtr;
    //////////////////////////////////////////////////////////////////////////
}
