...
namespace Mengine
{
    class ALSASoundBufferStream
        : public ALSASoundBufferBase
    {
        DECLARE_FACTORABLE( ALSASoundBufferStream );

    public:
        ALSASoundBufferStream();
        ~ALSASoundBufferStream() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<ALSASoundBufferStream, SoundBufferInterface> ALSASoundBufferStreamPtr;
    //////////////////////////////////////////////////////////////////////////
}
