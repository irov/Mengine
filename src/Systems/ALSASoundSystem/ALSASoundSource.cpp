...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    ALSASoundSource::ALSASoundSource()
        : m_volume( 1.f )
        , m_framePosition( 0 )
        , m_headMode( true )
        , m_playing( false )
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::initialize()
    {
        return true;
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::finalize()
    {
        this->stop();
    ...
    bool ALSASoundSource::play()
    {
        ...
        ALSASoundBufferBasePtr soundBuffer = this->getSoundBuffer_();
        ...
        else
        {
            ...
            ALSASoundSystemExtensionInterface * soundSystemExtension = SOUND_SYSTEM()
                ->getUnknown();
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::isPlay() const
    {
        return m_playing.load();
    }
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::isPause() const
    {
        return m_pausing.load();
    }
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::isFinished() const
    {
        return m_finished.load();
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::setVolume( float _volume )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    float ALSASoundSource::getVolume() const
    {
        return m_volume.load();
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::setLoop( bool _loop )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::getLoop() const
    {
        return m_loop.load();
    }
    //////////////////////////////////////////////////////////////////////////
    float ALSASoundSource::getDuration() const
    {
        ALSASoundBufferBasePtr soundBuffer = this->getSoundBuffer_();
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::setPosition( float _position )
    {
        ALSASoundBufferBasePtr soundBuffer = this->getSoundBuffer_();
    ...
    //////////////////////////////////////////////////////////////////////////
    float ALSASoundSource::getPosition() const
    {
        ALSASoundBufferBasePtr soundBuffer = this->getSoundBuffer_();
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::setSoundBuffer( const SoundBufferInterfacePtr & _soundBuffer )
    {
        this->unloadBuffer_();

        MENGINE_SPINLOCK_SCOPE( m_lock );
        m_soundBuffer = ALSASoundBufferBasePtr::from( _soundBuffer );
    }
    //////////////////////////////////////////////////////////////////////////
    const SoundBufferInterfacePtr & ALSASoundSource::getSoundBuffer() const
    {
        return m_soundBuffer;
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::setHeadMode( bool _headMode )
    {
        m_headMode = _headMode;
    }
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::getHeadMode() const
    {
        return m_headMode;
    }
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::renderMixerFrames( uint32_t _frames, uint32_t _outputChannels, float * _mixBuffer, float _gain )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::unloadBuffer_()
    {
        ALSASoundBufferBasePtr soundBuffer = this->getSoundBuffer_();
        uint32_t busIndex;
    ...
    //////////////////////////////////////////////////////////////////////////
    ALSASoundBufferBasePtr ALSASoundSource::getSoundBuffer_() const
    {
        MENGINE_SPINLOCK_SCOPE( m_lock );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::acquireSourceBus_( uint32_t _frequency, uint32_t _channels, float _gain )
    {
        ...
        if( soundSystemExtension->acquireSourceBus( ALSASoundSourcePtr::from( this ), _frequency, _channels, _gain, &busIndex ) == false )
        {
            return false;
        }
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::releaseSourceBus_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    uint32_t ALSASoundSource::detachBusIndex_()
    {
        MENGINE_SPINLOCK_SCOPE( m_lock );
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::beginMutableState_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::endMutableState_()
    {
        m_renderBarrier = false;
    }
    //////////////////////////////////////////////////////////////////////////
    bool ALSASoundSource::tryEnterRender_()
    {
        for( ;; )
        {
    ...
    //////////////////////////////////////////////////////////////////////////
    void ALSASoundSource::leaveRender_()
    {
        m_activeRenders.fetch_sub( 1 );
    }
    //////////////////////////////////////////////////////////////////////////
