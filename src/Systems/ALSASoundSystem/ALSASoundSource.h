...
namespace Mengine
{
    class ALSASoundSource
        : public SoundSourceInterface
        , public Factorable
    {
        DECLARE_FACTORABLE( ALSASoundSource );
    ...
    protected:
        ALSASoundBufferBasePtr getSoundBuffer_() const;
    ...
    protected:
        ...
        ALSASoundBufferBasePtr m_soundBuffer;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<ALSASoundSource, SoundSourceInterface> ALSASoundSourcePtr;
    //////////////////////////////////////////////////////////////////////////
}
