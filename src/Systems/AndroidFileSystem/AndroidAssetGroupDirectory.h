...
{
    //////////////////////////////////////////////////////////////////////////
    class AndroidAssetGroupDirectory
        : public BaseFileGroup
    {
        DECLARE_FACTORABLE( AndroidAssetGroupDirectory );

    public:
        AndroidAssetGroupDirectory();
        ~AndroidAssetGroupDirectory() override;
    ...
    public:
        ...
        bool closeOutputFile( const OutputStreamInterfacePtr & _stream, bool _successful ) override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<AndroidAssetGroupDirectory, FileGroupInterface> AndroidAssetGroupDirectoryPtr;
    //////////////////////////////////////////////////////////////////////////
}
