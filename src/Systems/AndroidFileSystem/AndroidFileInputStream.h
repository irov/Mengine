...
{
    //////////////////////////////////////////////////////////////////////////
    class AndroidFileInputStream
        : public FileInputStreamInterface
        , public Factorable
    {
        DECLARE_FACTORABLE( AndroidFileInputStream );

    public:
        AndroidFileInputStream();
        ~AndroidFileInputStream() override;
    ...
    protected:
        ...
        MENGINE_THREAD_GUARD_INIT( AndroidFileInputStream );
    };
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<AndroidFileInputStream, FileInputStreamInterface> AndroidFileInputStreamPtr;
    //////////////////////////////////////////////////////////////////////////
}
