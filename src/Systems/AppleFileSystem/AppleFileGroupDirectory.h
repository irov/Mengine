...
{
    //////////////////////////////////////////////////////////////////////////
    class AppleFileGroupDirectory
        : public BaseFileGroup
    {
        DECLARE_FACTORABLE( AppleFileGroupDirectory );

    public:
        AppleFileGroupDirectory();
        ~AppleFileGroupDirectory() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<AppleFileGroupDirectory, FileGroupInterface> AppleFileGroupDirectoryPtr;
    //////////////////////////////////////////////////////////////////////////
}
