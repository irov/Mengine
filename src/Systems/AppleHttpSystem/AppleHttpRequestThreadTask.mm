...
{
    //////////////////////////////////////////////////////////////////////////
    AppleHttpRequestThreadTask::AppleHttpRequestThreadTask()
        : m_id( 0 )
    ...
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setURL( const String & _url )
    {
        m_url = _url;
    }
    //////////////////////////////////////////////////////////////////////////
    const String & AppleHttpRequestThreadTask::getURL() const
    {
        return m_url;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setProxy( const String & _proxy )
    {
        m_proxy = _proxy;
    }
    //////////////////////////////////////////////////////////////////////////
    const String & AppleHttpRequestThreadTask::getProxy() const
    {
        return m_proxy;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setCookies( const String & _cookies )
    {
        m_cookies = _cookies;
    }
    //////////////////////////////////////////////////////////////////////////
    const String & AppleHttpRequestThreadTask::getCookies() const
    {
        return m_cookies;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setHeaders( const HttpRequestHeaders & _headers )
    {
        m_headers = _headers;
    }
    //////////////////////////////////////////////////////////////////////////
    const HttpRequestHeaders & AppleHttpRequestThreadTask::getHeaders() const
    {
        return m_headers;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setRequestId( HttpRequestId _id )
    {
        m_id = _id;
    }
    //////////////////////////////////////////////////////////////////////////
    HttpRequestId AppleHttpRequestThreadTask::getRequestId() const
    {
        return m_id;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setTimeout( int32_t _timeout )
    {
        m_timeout = _timeout;
    }
    //////////////////////////////////////////////////////////////////////////
    int32_t AppleHttpRequestThreadTask::getTimeout() const
    {
        return m_timeout;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setReceiveHeaders( bool _receiveHeaders )
    {
        m_receiveHeaders = _receiveHeaders;
    }
    //////////////////////////////////////////////////////////////////////////
    bool AppleHttpRequestThreadTask::getReceiveHeaders() const
    {
        return m_receiveHeaders;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setReponse( const HttpResponseInterfacePtr & _response )
    {
        m_response = _response;
    }
    //////////////////////////////////////////////////////////////////////////
    const HttpResponseInterfacePtr & AppleHttpRequestThreadTask::getReponse() const
    {
        return m_response;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::setReceiver( const HttpReceiverInterfacePtr & _receiver )
    {
        m_receiver = _receiver;
    }
    //////////////////////////////////////////////////////////////////////////
    const HttpReceiverInterfacePtr & AppleHttpRequestThreadTask::getReceiver() const
    {
        return m_receiver;
    }
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::_onThreadTaskPreparation()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AppleHttpRequestThreadTask::_onThreadTaskRun()
    {
        //Empty
    ...
    //////////////////////////////////////////////////////////////////////////
    bool AppleHttpRequestThreadTask::_onThreadTaskProcess()
    {
        ...
        jobject jurl = Helper::AppleMakeJObjectString( jenv, m_url );
        jobject jproxy = Helper::AppleMakeJObjectString( jenv, m_proxy );

        HttpRequestHeaders::size_type headers_size = m_headers.size();

        jobject jheaders = Helper::AppleMakeJObjectArrayList( jenv, headers_size );

        for( const String & header : m_headers )
        {
            jobject jheader = Helper::AppleMakeJObjectString( jenv, header );

            Helper::AppleAddJObjectList( jenv, jheaders, jheader );

            jenv->DeleteLocalRef( jheader );
        }

        jobject jcookies = Helper::AppleMakeJObjectString( jenv, m_cookies );

        jclass jclass_MengineHttpRequestParam = ::Mengine_JNI_FindClass( jenv, "org/Mengine/Base/MengineHttpRequestParam" );

        Helper::AppleEnvExceptionCheck( jenv );
        ...
        if( m_response != nullptr )
        {
            ...
            {
                String error_message = Helper::AppleMakeStringFromJString( jenv, HTTP_ERROR_MESSAGE );
    ...
    //////////////////////////////////////////////////////////////////////////
    void AppleHttpRequestThreadTask::_onThreadTaskComplete( bool _successful )
    {
