...
{
    //////////////////////////////////////////////////////////////////////////
    class AudioUnitSoundBufferBase
        : public SoundBufferInterface
    {
    public:
        AudioUnitSoundBufferBase();
        ~AudioUnitSoundBufferBase() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<AudioUnitSoundBufferBase, SoundBufferInterface> AudioUnitSoundBufferBasePtr;
    //////////////////////////////////////////////////////////////////////////
}
