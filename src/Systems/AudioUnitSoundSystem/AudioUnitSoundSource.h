...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    class AudioUnitSoundSource
        : public SoundSourceInterface
        , public Factorable
    {
        DECLARE_FACTORABLE( AudioUnitSoundSource );
    ...
    public:
        AudioUnitSoundSource();
        ~AudioUnitSoundSource() override;
    ...
    protected:
        AudioUnitSoundBufferBasePtr getSoundBuffer_() const;
    ...
    protected:
        ...
        AudioUnitSoundBufferBasePtr m_soundBuffer;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<AudioUnitSoundSource, SoundSourceInterface> AudioUnitSoundSourcePtr;
    //////////////////////////////////////////////////////////////////////////
}
