    ...
    namespace Helper
    {
        ...
        const Char * getDX11ErrorMessage( HRESULT _hr )
        {
            switch( _hr )
            {
                ...
                MENGINE_MESSAGE_CASE( D3D11_ERROR_DEFERRED_CONTEXT_MAP_WITHOUT_INITIAL_DISCARD, "Check D3D11_ERROR_DEFERRED_CONTEXT_MAP_WITHOUT_INITIAL_DISCARD description" );
                ...
                MENGINE_MESSAGE_CASE( DXGI_ERROR_NAME_ALREADY_EXISTS, "Check DXGI_ERROR_NAME_ALREADY_EXISTS" );
                ...
                MENGINE_MESSAGE_CASE( DXGI_ERROR_NOT_FOUND, "Check DXGI_ERROR_NOT_FOUND" );
                MENGINE_MESSAGE_CASE( DXGI_ERROR_REMOTE_CLIENT_DISCONNECTED, "DXGI_ERROR_REMOTE_CLIENT_DISCONNECTED" );
                MENGINE_MESSAGE_CASE( DXGI_ERROR_REMOTE_OUTOFMEMORY, "DXGI_ERROR_REMOTE_OUTOFMEMORY" );
