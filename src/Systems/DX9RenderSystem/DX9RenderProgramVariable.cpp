...
namespace Mengine
{
    ...
    bool DX9RenderProgramVariable::apply( IDirect3DDevice9 * _pD3DDevice, const RenderProgramInterfacePtr & _program )
    {
        ...
        for( const ProgramVariableDesc & v : m_vertexVariables )
        {
            ...
            MENGINE_IF_DX9_CALL( _pD3DDevice, SetVertexShaderConstantF, (vertexEnumerator, buff, v.count) )
            {
                return false;
            }
        ...
        for( const ProgramVariableDesc & v : m_pixelVariables )
        {
            ...
            MENGINE_IF_DX9_CALL( _pD3DDevice, SetPixelShaderConstantF, (pixelEnumerator, buff, v.count) )
            {
                return false;
            }
