...
{
    //////////////////////////////////////////////////////////////////////////
    class MetalRenderProgramVariable
        : public RenderProgramVariableInterface
        , public Factorable
    {
        DECLARE_FACTORABLE( MetalRenderProgramVariable );

    public:
        MetalRenderProgramVariable();
        ~MetalRenderProgramVariable() override;
    ...
    public:
        bool apply( id<MTLRenderCommandEncoder> _encoder );
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<MetalRenderProgramVariable, RenderProgramVariableInterface> MetalRenderProgramVariablePtr;
    //////////////////////////////////////////////////////////////////////////
}
