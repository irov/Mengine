...
{
	//////////////////////////////////////////////////////////////////////////
	inline GLenum s_getGLIndexType()
	{
    ...
    //////////////////////////////////////////////////////////////////////////
	inline GLenum s_toGLBlendFactor( EBlendFactor _filter )
	{
		switch( _filter )
		{
	...
	//////////////////////////////////////////////////////////////////////////
	inline GLenum s_toGLBlendFactor( EBlendOp _filter )
	{
		switch( _filter )
		{
    ...
    //////////////////////////////////////////////////////////////////////////
	inline GLenum s_toGLCmpFunc( ECompareFunction _function )
    {
		switch( _function )
		{
    ...
    //////////////////////////////////////////////////////////////////////////
	inline GLenum s_toMagFilter( ETextureFilter _magFilter )
    {
		switch( _magFilter )
		{
		case TF_NONE:
    ...
    //////////////////////////////////////////////////////////////////////////
	inline GLenum s_toGLInternalFormat( PixelFormat _format )
    {
	    switch( _format )
	    {
	    case PF_A8B8G8R8:
