...
{
    //////////////////////////////////////////////////////////////////////////
    OpenSLESSoundBufferBase::OpenSLESSoundBufferBase()
        : m_frequency( 0 )
        , m_channels( 0 )
        , m_duration( 0.f )
        , m_isStereo( false )
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferBase::acquireSoundBuffer()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferBase::releaseSoundBuffer()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferBase::_acquireSoundBuffer()
    {
        //Empty
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferBase::_releaseSoundBuffer()
    {
        //Empty
    }
    //////////////////////////////////////////////////////////////////////////
    const SoundDecoderInterfacePtr & OpenSLESSoundBufferBase::getDecoder() const
    {
        return m_soundDecoder;
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferBase::isStereo() const
    {
        return m_isStereo;
    }
    //////////////////////////////////////////////////////////////////////////
    float OpenSLESSoundBufferBase::getTimeDuration() const
    {
        return m_duration;
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferBase::isFinished() const
    {
        return m_finished.load();
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferBase::createPlayer_()
    {
        OpenSLESSoundSystemExtensionInterface * soundSystemExtension = SOUND_SYSTEM()
            ->getUnknown();
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferBase::destroyPlayer_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    SLmillibel OpenSLESSoundBufferBase::gainToMillibels_( float _gain )
    {
        if( _gain <= 0.0001f )
        {
