...
{
    //////////////////////////////////////////////////////////////////////////
    class OpenSLESSoundBufferBase
        : public SoundBufferInterface
    {
    public:
        OpenSLESSoundBufferBase();
        ~OpenSLESSoundBufferBase() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<OpenSLESSoundBufferBase, SoundBufferInterface> OpenSLESSoundBufferBasePtr;
    //////////////////////////////////////////////////////////////////////////
}
