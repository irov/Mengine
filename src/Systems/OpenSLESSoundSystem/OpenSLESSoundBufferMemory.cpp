...
{
    //////////////////////////////////////////////////////////////////////////
    OpenSLESSoundBufferMemory::OpenSLESSoundBufferMemory()
        : m_pcmDataSize( 0 )
        , m_looped( false )
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferMemory::_acquireSoundBuffer()
    {
        //Empty
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferMemory::_releaseSoundBuffer()
    {
        this->destroyPlayer_();
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferMemory::updateSoundBuffer()
    {
        //Empty
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferMemory::load( const SoundDecoderInterfacePtr & _soundDecoder )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferMemory::bufferQueueCallback_( SLAndroidSimpleBufferQueueItf _bq, void * _context )
    {
        MENGINE_UNUSED( _bq );

        OpenSLESSoundBufferMemory * buffer = static_cast<OpenSLESSoundBufferMemory *>(_context);
        buffer->onBufferConsumed_();
    }
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferMemory::onBufferConsumed_()
    {
        if( m_looped == true )
        {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferMemory::playSource( bool _looped, float _position )
    {
        ...
        (*m_bufferQueueItf)->RegisterCallback( m_bufferQueueItf, &OpenSLESSoundBufferMemory::bufferQueueCallback_, this );
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferMemory::stopSource()
    {
        if( m_playerObject == nullptr )
        {
            return;
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferMemory::pauseSource()
    {
        if( m_playerObject == nullptr )
        {
            return;
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferMemory::resumeSource()
    {
        if( m_playerObject == nullptr )
        {
            return;
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferMemory::setTimePosition( float _position )
    {
        if( m_playerObject == nullptr )
        {
            return false;
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferMemory::getTimePosition( float * const _position ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferMemory::setVolume( float _gain )
    {
