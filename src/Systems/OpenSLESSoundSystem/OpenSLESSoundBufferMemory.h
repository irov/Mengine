...
{
    //////////////////////////////////////////////////////////////////////////
    class OpenSLESSoundBufferMemory
        : public OpenSLESSoundBufferBase
    {
        DECLARE_FACTORABLE( OpenSLESSoundBufferMemory );

    public:
        OpenSLESSoundBufferMemory();
        ~OpenSLESSoundBufferMemory() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<OpenSLESSoundBufferMemory, SoundBufferInterface> OpenSLESSoundBufferMemoryPtr;
    //////////////////////////////////////////////////////////////////////////
}
