...
{
    //////////////////////////////////////////////////////////////////////////
    OpenSLESSoundBufferStream::OpenSLESSoundBufferStream()
        : m_currentBuffer( 0 )
        , m_looped( false )
        , m_updating( false )
        , m_consumedCount( 0 )
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferStream::_acquireSoundBuffer()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::_releaseSoundBuffer()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferStream::load( const SoundDecoderInterfacePtr & _soundDecoder )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::bufferQueueCallback_( SLAndroidSimpleBufferQueueItf _bq, void * _context )
    {
        MENGINE_UNUSED( _bq );

        OpenSLESSoundBufferStream * stream = static_cast<OpenSLESSoundBufferStream *>(_context);
        stream->onBufferConsumed_();
    }
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::onBufferConsumed_()
    {
        ++m_consumedCount;
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferStream::playSource( bool _looped, float _position )
    {
        ...
        (*m_bufferQueueItf)->RegisterCallback( m_bufferQueueItf, &OpenSLESSoundBufferStream::bufferQueueCallback_, this );
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::stopSource()
    {
        this->setUpdating_( false );
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::pauseSource()
    {
        if( m_playerObject == nullptr )
        {
            return;
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::resumeSource()
    {
        if( m_playerObject == nullptr )
        {
            return;
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::setUpdating_( bool _updating )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferStream::setTimePosition( float _position )
    {
        MENGINE_THREAD_MUTEX_SCOPE( m_mutexUpdating );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferStream::getTimePosition( float * const _position ) const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferStream::updateSoundBuffer()
    {
        MENGINE_THREAD_MUTEX_SCOPE( m_mutexUpdating );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundBufferStream::fillBuffer_( uint32_t _bufferIndex, size_t * const _bytes )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundBufferStream::setVolume( float _gain )
    {
        ...
        SLmillibel mb = OpenSLESSoundBufferBase::gainToMillibels_( _gain );
