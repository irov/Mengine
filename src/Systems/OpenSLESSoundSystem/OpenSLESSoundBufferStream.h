...
{
    //////////////////////////////////////////////////////////////////////////
    class OpenSLESSoundBufferStream
        : public OpenSLESSoundBufferBase
    {
        DECLARE_FACTORABLE( OpenSLESSoundBufferStream );

    public:
        OpenSLESSoundBufferStream();
        ~OpenSLESSoundBufferStream() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<OpenSLESSoundBufferStream, SoundBufferInterface> OpenSLESSoundBufferStreamPtr;
    //////////////////////////////////////////////////////////////////////////
}
