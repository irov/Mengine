...
namespace Mengine
{
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::initialize()
    {
        //Empty
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundSource::finalize()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::resume()
    {
        if( m_playing == false )
        {
            return false;
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::isPlay() const
    {
        return m_playing;
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::isPause() const
    {
        return m_pausing;
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::isFinished() const
    {
        if( m_soundBuffer == nullptr )
        {
            return false;
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundSource::setVolume( float _volume )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundSource::setLoop( bool _loop )
    {
        m_loop = _loop;
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::getLoop() const
    {
        return m_loop;
    }
    //////////////////////////////////////////////////////////////////////////
    float OpenSLESSoundSource::getDuration() const
    {
        if( m_soundBuffer == nullptr )
        {
            LOGGER_ASSERTION( "invalid sound buffer" );
    ...
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::setPosition( float _position )
    {
        if( m_soundBuffer == nullptr )
        {
            LOGGER_ASSERTION( "invalid sound buffer" );
    ...
    //////////////////////////////////////////////////////////////////////////
    float OpenSLESSoundSource::getPosition() const
    {
        if( m_soundBuffer == nullptr )
        {
            LOGGER_ASSERTION( "invalid sound buffer" );
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundSource::setSoundBuffer( const SoundBufferInterfacePtr & _soundBuffer )
    {
        this->unloadBuffer_();

        m_soundBuffer = OpenSLESSoundBufferBasePtr::from( _soundBuffer );
    }
    //////////////////////////////////////////////////////////////////////////
    const SoundBufferInterfacePtr & OpenSLESSoundSource::getSoundBuffer() const
    {
        return m_soundBuffer;
    }
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundSource::unloadBuffer_()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void OpenSLESSoundSource::setHeadMode( bool _headMode )
    {
        m_headMode = _headMode;
    }
    //////////////////////////////////////////////////////////////////////////
    bool OpenSLESSoundSource::getHeadMode() const
    {
        return m_headMode;
    }
    //////////////////////////////////////////////////////////////////////////
