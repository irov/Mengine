...
{
    //////////////////////////////////////////////////////////////////////////
    class POSIXFileGroupDirectory
        : public BaseFileGroup
    {
        DECLARE_FACTORABLE( POSIXFileGroupDirectory );

    public:
        POSIXFileGroupDirectory();
        ~POSIXFileGroupDirectory() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<POSIXFileGroupDirectory, FileGroupInterface> POSIXFileGroupDirectoryPtr;
    //////////////////////////////////////////////////////////////////////////
}
