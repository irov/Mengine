...
namespace Mengine
{
    ...
    class POSIXFileInputStream
        ...
        , public Factorable
    {
        DECLARE_FACTORABLE( POSIXFileInputStream );

    public:
        POSIXFileInputStream();
        ~POSIXFileInputStream() override;
    ...
    protected:
        ...
        MENGINE_THREAD_GUARD_INIT( POSIXFileInputStream );
    };
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<POSIXFileInputStream, FileInputStreamInterface> POSIXFileInputStreamPtr;
    //////////////////////////////////////////////////////////////////////////
}
