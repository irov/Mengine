...
{
    //////////////////////////////////////////////////////////////////////////
    class POSIXMutexFileInputStream
        : public FileInputStreamInterface
        , public Factorable
    {
        DECLARE_FACTORABLE( POSIXMutexFileInputStream );

    public:
        POSIXMutexFileInputStream();
        ~POSIXMutexFileInputStream() override;

    public:
        void setFileInputStream( const POSIXFileInputStreamPtr & _stream );
    ...
    protected:
        POSIXFileInputStreamPtr m_stream;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<POSIXMutexFileInputStream, FileInputStreamInterface> POSIXMutexFileInputStreamPtr;
    //////////////////////////////////////////////////////////////////////////
}
