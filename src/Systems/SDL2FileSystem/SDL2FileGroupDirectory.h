...
{
    //////////////////////////////////////////////////////////////////////////
    class SDL2FileGroupDirectory
        : public BaseFileGroup
    {
        DECLARE_FACTORABLE( SDL2FileGroupDirectory );

    public:
        SDL2FileGroupDirectory();
        ~SDL2FileGroupDirectory() override;
    ...
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<SDL2FileGroupDirectory, FileGroupInterface> SDL2FileGroupDirectoryPtr;
    //////////////////////////////////////////////////////////////////////////
}
