...
namespace Mengine
{
    ...
    protected:
        ...
        MENGINE_THREAD_GUARD_INIT( SDL2FileInputStream );
    };
    //////////////////////////////////////////////////////////////////////////
    typedef IntrusivePtr<SDL2FileInputStream, FileInputStreamInterface> SDL2FileInputStreamPtr;
    //////////////////////////////////////////////////////////////////////////
}
