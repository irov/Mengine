...
{
    //////////////////////////////////////////////////////////////////////////
    class SDL3MutexFileInputStream
        : public FileInputStreamInterface
        , public Factorable
    {
        DECLARE_FACTORABLE( SDL3MutexFileInputStream );

    public:
        SDL3MutexFileInputStream();
        ~SDL3MutexFileInputStream() override;

    public:
        bool initialize( const SDL3FileInputStreamPtr & _stream, const ThreadMutexInterfacePtr & _mutex );
    ...
    protected:
        SDL3FileInputStreamPtr m_stream;
