...
//////////////////////////////////////////////////////////////////////////
SERVICE_FACTORY( UnicodeSystem, Mengine::SDL3UnicodeSystem );
//////////////////////////////////////////////////////////////////////////
namespace Mengine
{
    //////////////////////////////////////////////////////////////////////////    
...
#endif
    //////////////////////////////////////////////////////////////////////////
    SDL3UnicodeSystem::SDL3UnicodeSystem()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    SDL3UnicodeSystem::~SDL3UnicodeSystem()
    ...
    //////////////////////////////////////////////////////////////////////////
    const ServiceRequiredList & SDL3UnicodeSystem::requiredServices() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL3UnicodeSystem::_initializeService()
    {
        ThreadMutexInterfacePtr mutex = THREAD_SYSTEM()
            ->createMutex( MENGINE_DOCUMENT_FACTORABLE );

        MENGINE_ASSERTION_MEMORY_PANIC( mutex, "can't create unicode mutex" );
    ...
    //////////////////////////////////////////////////////////////////////////
    void SDL3UnicodeSystem::_finalizeService()
    {
        m_mutex = nullptr;
    }
    //////////////////////////////////////////////////////////////////////////
    bool SDL3UnicodeSystem::unicodeToUtf8( const WChar * _unicode, size_t _unicodeSize, Char * const _utf8, size_t _utf8Capacity, size_t * const _utf8Size )
    {
        MENGINE_THREAD_MUTEX_SCOPE( m_mutex );

        SDL_iconv_t cd = SDL_iconv_open( "UTF-8", SDL_UCS_wchar_t );

        if( cd == (SDL_iconv_t)SDL_ICONV_ERROR )
        {
            return false;
        }
        ...
        const char * iconv_inbuf = reinterpret_cast<const char *>(_unicode);
        size_t iconv_insize = unicodeSize * sizeof( WChar );

        char * iconv_outbuf = reinterpret_cast<char *>(_utf8);
        ...
        if( _utf8 == nullptr )
        {
            ...
            iconv_outbuf = reinterpret_cast<char *>(m_utf8Buffer);
    ...
    //////////////////////////////////////////////////////////////////////////
    bool SDL3UnicodeSystem::utf8ToUnicode( const Char * _utf8, size_t _utf8Size, WChar * const _unicode, size_t _unicodeCapacity, size_t * const _sizeUnicode )
    {
        MENGINE_THREAD_MUTEX_SCOPE( m_mutex );
        ...
        const char * iconv_inbuf = reinterpret_cast<const char *>(_utf8);
        size_t iconv_insize = utf8Size * sizeof( Char );

        char * iconv_outbuf = reinterpret_cast<char *>(_unicode);
        ...
        if( _unicode == nullptr )
        {
            ...
            iconv_outbuf = reinterpret_cast<char *>(m_unicodeBuffer);
