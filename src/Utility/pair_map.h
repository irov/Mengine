...
namespace Utility
{
	...
	public:
		...
		{
			TListValue::iterator it_value = _Lv.insert(_Lv.end(),value);
			_Fkv.insert(std::make_pair(key1,MakePairKeyValueIterator(key2,it_value)));
			_Skv.insert(std::make_pair(key2,MakePairKeyValueIterator(key1,it_value)));
		}
