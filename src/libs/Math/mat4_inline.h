...
namespace mt
{
	...
	MATH_INLINE void mul_m4_v3(vec3f& _out, const mat4f& _m,const vec3f& _v)
	{
		...
		_out.x = _m.m[0] * _v.x + _m.m[1] * _v.y + _m.m[2] * _v.z + _m.m[3];
		_out.y = _m.m[4] * _v.x + _m.m[5] * _v.y + _m.m[6] * _v.z + _m.m[7];
		_out.z = _m.m[8] * _v.x + _m.m[9] * _v.y + _m.m[10] * _v.z + _m.m[11];
	}
	...
	MATH_INLINE void mul_v3_m4(vec3f& _out, const vec3f& _v,const mat4f& _m)
	{
		...
		_out.x = _m.m[0] * _v.x + _m.m[4] * _v.y + _m.m[8] * _v.z + _m.m[12];
		_out.y = _m.m[1] * _v.x + _m.m[5] * _v.y + _m.m[9] * _v.z + _m.m[13];
		_out.z = _m.m[2] * _v.x + _m.m[6] * _v.y + _m.m[10] * _v.z + _m.m[14];
	}
	//////////////////////////////////////////////////////////////////////////
	MATH_INLINE void mul_v2_m4(vec2f& _out, const vec2f& _v,const mat4f& _m)
	{
		...
		_out.x = _m.m[0] * _v.x + _m.m[4] * _v.y + _m.m[12];
		_out.y = _m.m[1] * _v.x + _m.m[5] * _v.y + _m.m[13];
	}
	//////////////////////////////////////////////////////////////////////////
	...
	MATH_INLINE void mul_m4_v4(vec4f& _out, const mat4f& _m,const vec4f& _v)
	{
		...
		_out.y = _m.m[4] * _v.x + _m.m[5] * _v.y + _m.m[6] * _v.z + _m.m[7];
		_out.z = _m.m[8] * _v.x + _m.m[9] * _v.y + _m.m[10] * _v.z + _m.m[11];
		_out.w = _m.m[12] * _v.x + _m.m[13] * _v.y + _m.m[14] * _v.z + _m.m[15];
	}
	...
	MATH_INLINE void mul_v4_m4(vec4f& _out, const vec4f& _v, const mat4f& _m)
	{
		...
		_out.y = _m.m[1] * _v.x + _m.m[5] * _v.y + _m.m[9] * _v.z + _m.m[13];
		_out.z = _m.m[2] * _v.x + _m.m[6] * _v.y + _m.m[10] * _v.z + _m.m[14];
		_out.w = _m.m[3] * _v.x + _m.m[7] * _v.y + _m.m[11] * _v.z + _m.m[15];
	}
	...
	MATH_INLINE void mul_m4_m4(mat4f& _out, const mat4f& _a, const mat4f& _b)
	{
		...
		_out.m[0] = _a.m[0] * _b.m[0] + _a.m[1] * _b.m[4]+ _a.m[2] * _b.m[8]+ _a.m[3] * _b.m[12];
		_out.m[1] = _a.m[0] * _b.m[1] + _a.m[1] * _b.m[5]+ _a.m[2] * _b.m[9]+ _a.m[3] * _b.m[13];
		_out.m[2] = _a.m[0] * _b.m[2] + _a.m[1] * _b.m[6]+ _a.m[2] * _b.m[10]+ _a.m[3] * _b.m[14];
		_out.m[3] = _a.m[0] * _b.m[3] + _a.m[1] * _b.m[7]+ _a.m[2] * _b.m[11]+ _a.m[3] * _b.m[15];
		_out.m[4] = _a.m[4] * _b.m[0] + _a.m[5] * _b.m[4]+ _a.m[6] * _b.m[8]+ _a.m[7] * _b.m[12];
		_out.m[5] = _a.m[4] * _b.m[1] + _a.m[5] * _b.m[5]+ _a.m[6] * _b.m[9]+ _a.m[7] * _b.m[13];
		_out.m[6] = _a.m[4] * _b.m[2] + _a.m[5] * _b.m[6]+ _a.m[6] * _b.m[10]+ _a.m[7] * _b.m[14];
		_out.m[7] = _a.m[4] * _b.m[3] + _a.m[5] * _b.m[7]+ _a.m[6] * _b.m[11]+ _a.m[7] * _b.m[15];
		_out.m[8] = _a.m[8] * _b.m[0] + _a.m[9] * _b.m[4]+ _a.m[10] * _b.m[8]+ _a.m[11] * _b.m[12];
		_out.m[9] = _a.m[8] * _b.m[1] + _a.m[9] * _b.m[5]+ _a.m[10] * _b.m[9]+ _a.m[11] * _b.m[13];
		_out.m[10] = _a.m[8] * _b.m[2] + _a.m[9] * _b.m[6]+ _a.m[10] * _b.m[10]+ _a.m[11] * _b.m[14];
		_out.m[11] = _a.m[8] * _b.m[3] + _a.m[9] * _b.m[7]+ _a.m[10] * _b.m[11]+ _a.m[11] * _b.m[15];
		_out.m[12] = _a.m[12] * _b.m[0] + _a.m[13] * _b.m[4]+ _a.m[14] * _b.m[8]+ _a.m[15] * _b.m[12];
		_out.m[13] = _a.m[12] * _b.m[1] + _a.m[13] * _b.m[5]+ _a.m[14] * _b.m[9]+ _a.m[15] * _b.m[13];
		_out.m[14] = _a.m[12] * _b.m[2] + _a.m[13] * _b.m[6]+ _a.m[14] * _b.m[10]+ _a.m[15] * _b.m[14];
		_out.m[15] = _a.m[12] * _b.m[3] + _a.m[13] * _b.m[7]+ _a.m[14] * _b.m[11]+ _a.m[15] * _b.m[15];
	}
	/*	Matrix/Matrix Mult  */
	MATH_INLINE void mul_m4_m3(mat4f& _out, const mat4f& _a, const mat3f& _b)
	{
		...
		_out.m[4] = _a.m[4] * _b.m[0] + _a.m[5] * _b.m[3]+ _a.m[6] * _b.m[6];
		_out.m[5] = _a.m[4] * _b.m[1] + _a.m[5] * _b.m[4]+ _a.m[6] * _b.m[7];
		_out.m[6] = _a.m[4] * _b.m[2] + _a.m[5] * _b.m[5]+ _a.m[6] * _b.m[8];
		_out.m[8] = _a.m[8] * _b.m[0] + _a.m[9] * _b.m[3]+ _a.m[10] * _b.m[6];
		_out.m[9] = _a.m[8] * _b.m[1] + _a.m[9] * _b.m[4]+ _a.m[10] * _b.m[7];
		_out.m[10] = _a.m[8] * _b.m[2] + _a.m[9] * _b.m[5]+ _a.m[10] * _b.m[8];
		_out.m[12] = _a.m[12];
		_out.m[13] = _a.m[13];
		_out.m[14] = _a.m[14];
		_out.m[15] = _a.m[15];
	...
	MATH_INLINE void scale_rotate_m4_m4(mat4f& _out, const mat4f& _rhs, const mt::vec3f & _val)
	{
		...
		for( int i = 0; i < 3; i++ )
		{
			_out.m[i] = _rhs.m[i] * _val.x;
		}
		for( int i = 4; i < 7; i++ )
		{
			_out.m[i] = _rhs.m[i] * _val.y;
		}
		for( int i = 8; i < 11; i++ )
		{
			_out.m[i] = _rhs.m[i] * _val.z;
		}
	}
	...
	MATH_INLINE void ident_m4(mat4f& _out)
	{
		...
		=_out[3][3]
		=1.0f;*/
		std::fill( &(_out.m[0]), &(_out.m[16]), 0.0f );
		_out.m[0] = _out.m[5] = _out.m[10] = _out.m[15] = 1.0f;
	}
  ...
  //      out.z = _rhs[2][_index];
		//out.w = _rhs[3][_index];
		out.x = _rhs.m[_index];
		out.y = _rhs.m[_index+4];
		out.z = _rhs.m[_index+8];
		out.w = _rhs.m[_index+12];
    }
	...
	MATH_INLINE void set_col_m4(mat4f& out, const vec4f& _rhs, int _index)
	{
		...
		//out[3][_index] = _rhs.z;
		out.m[_index] = _rhs.x;
		out.m[_index+4] = _rhs.y;
		out.m[_index+8] = _rhs.z;
		out.m[_index+12] = _rhs.w;
	}
	...
	MATH_INLINE void extract_m3(mat3f& _out, const mat4f& _rhs)
	{
		...
		//_out.v1 = _rhs.v3_1;
		//_out.v2 = _rhs.v3_2;
		_out.m[0] = _rhs.m[0]; _out.m[1] = _rhs.m[1]; _out.m[2] = _rhs.m[2];
		_out.m[3] = _rhs.m[4]; _out.m[4] = _rhs.m[5]; _out.m[5] = _rhs.m[6];
		_out.m[6] = _rhs.m[8]; _out.m[7] = _rhs.m[9]; _out.m[8] = _rhs.m[10];
	}
	...
	MATH_INLINE float minor_m4(const mat4f& _rhs, const int r0, const int r1, const int r2, const int c0, const int c1, const int c2)
	{
		...
		return		_rhs.m[r0*4+c0] * (_rhs.m[r1*4+c1] * _rhs.m[r2*4+c2] - _rhs.m[r2*4+c1] * _rhs.m[r1*4+c2]) -
				_rhs.m[r0*4+c1] * (_rhs.m[r1*4+c0] * _rhs.m[r2*4+c2] - _rhs.m[r2*4+c0] * _rhs.m[r1*4+c2]) +
				_rhs.m[r0*4+c2] * (_rhs.m[r1*4+c0] * _rhs.m[r2*4+c1] - _rhs.m[r2*4+c0] * _rhs.m[r1*4+c1]);
	...
	MATH_INLINE float det_m4(const mat4f& _rhs)
	{
		...
		return	_rhs.m[0] * minor_m4(_rhs, 1, 2, 3, 1, 2, 3) -
				_rhs.m[1] * minor_m4(_rhs, 1, 2, 3, 0, 2, 3) +
				_rhs.m[2] * minor_m4(_rhs, 1, 2, 3, 0, 1, 3) -
				_rhs.m[3] * minor_m4(_rhs, 1, 2, 3, 0, 1, 2);
	}
	...
	MATH_INLINE void adj_m4(mat4f& _out, const mat4f& _rhs)
	{
		...
		_out.m[0] =  minor_m4(_rhs, 1, 2, 3, 1, 2, 3);
		_out.m[1] = -minor_m4(_rhs, 0, 2, 3, 1, 2, 3);
		_out.m[2] =  minor_m4(_rhs, 0, 1, 3, 1, 2, 3);
		_out.m[3] = -minor_m4(_rhs, 0, 1, 2, 1, 2, 3);

		_out.m[4] = -minor_m4(_rhs, 1, 2, 3, 0, 2, 3);
		_out.m[5] =  minor_m4(_rhs, 0, 2, 3, 0, 2, 3);
		_out.m[6] = -minor_m4(_rhs, 0, 1, 3, 0, 2, 3);
		_out.m[7] =  minor_m4(_rhs, 0, 1, 2, 0, 2, 3);

		_out.m[8] =  minor_m4(_rhs, 1, 2, 3, 0, 1, 3);
		_out.m[9] = -minor_m4(_rhs, 0, 2, 3, 0, 1, 3);
		_out.m[10] =  minor_m4(_rhs, 0, 1, 3, 0, 1, 3);
		_out.m[11] = -minor_m4(_rhs, 0, 1, 2, 0, 1, 3);

		_out.m[12] = -minor_m4(_rhs, 1, 2, 3, 0, 1, 2);
		_out.m[13] =  minor_m4(_rhs, 0, 2, 3, 0, 1, 2);
		_out.m[14] = -minor_m4(_rhs, 0, 1, 3, 0, 1, 2);
		_out.m[15] =  minor_m4(_rhs, 0, 1, 2, 0, 1, 2);
	}
	...
	MATH_INLINE void rotate_axis_m4( mat4f &out, const vec3f &u, float degrees )
	{
		...
		m.m[0] = c+ic*u.x*u.x; m.m[1] = icuxy - suz; m.m[2] = icuxz + suy;
		m.m[3] = icuxy + suz; m.m[4] = c+ic*u.y*u.y; m.m[5] = icuyz - sux;
		m.m[6] = icuxz - suy; m.m[7] = icuyz + sux; m.m[8] = c+ic*u.z*u.z;
	...
	MATH_INLINE void make_projection_m4( mat4f & out , float fovy, float aspect, float zn, float zf )
	{
		...
		out.m[0] = xscale;	out.m[1] = 0.f;	out.m[2] = 0.f;					out.m[3] = 0.f;
		out.m[4] = 0.f;	out.m[5] = yscale;	out.m[6] = 0.f;					out.m[7] = 0.f;
		out.m[8] = 0.f;	out.m[9] = 0.f;	out.m[10] = zf / (zf - zn);			out.m[11] = 1.f;
		out.m[12] = 0.f;	out.m[13] = 0.f;	out.m[14] = -zn * zf / (zf - zn);	out.m[15] = 0.f;
	}
}