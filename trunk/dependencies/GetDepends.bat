...
call:getdepend2 https://www.python.org/ftp/python/2.7.10/Python-2.7.10.tgz Python-2.7.10.tgz Python-2.7.10.tar Python-2.7.10 Python
call:getdepend2 https://www.python.org/ftp/python/3.4.3/Python-3.4.3.tgz Python-3.4.3.tgz Python-3.4.3.tar Python-3.4.3 Python3
