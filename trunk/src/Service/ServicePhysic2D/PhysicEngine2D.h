...
namespace Menge
{
	...
	class PhysicEngine2D
        : public PhysicService2DInterface
	{
	public:
		PhysicEngine2D();
		~PhysicEngine2D();
    ...
    public:
		...
		void createWorld( const mt::vec2f& _upperLeft, const mt::vec2f& _lowerRight, const mt::vec2f& _gravity, bool _doSleep = true ) override;
	...
	private:
		PhysicSystem2DInterface* m_physicSystem;
