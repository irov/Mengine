...
namespace Menge
{
	...
	//////////////////////////////////////////////////////////////////////////
	void FactoryManager::registerFactory( const ConstString & _type, const FactoryPtr & _factory )
	{
	...
	Factorable * FactoryManager::createObject( const ConstString & _type )
	{
        ...
        const FactoryPtr & factory = m_factories.get_value(it_found);
	...
	void FactoryManager::visitFactories( VisitorFactoryManager * _visit )
	{
		...
		++it )
		{
			...
			const FactoryPtr & factory = m_factories.get_value( it );
