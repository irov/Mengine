...
{ 
	...
	MATH_METHOD_INLINE mat2f& mat2f::operator=(const mat2f& _rhs)
	{
		v0 = _rhs.v0;
		v1 = _rhs.v1;
		return *this;
	...
	MATH_METHOD_INLINE bool cmp_m2_m2(const mat2f& _a, const mat2f& _b)
	{ 
		return cmp_v2_v2(_a.v0,_b.v0) &&
			cmp_v2_v2(_a.v1,_b.v1);
	}

	MATH_METHOD_INLINE bool operator==(const mat2f& _a, const mat2f& _b)
	{
	...
	MATH_FUNCTION_INLINE vec2f operator*(const mat2f& m, const vec2f& v)
	{
		vec2f out;
		mul_m2_v2(out,m,v);
		return out;
